...
var file_yelp_nrtsearch_search_proto_rawDesc = []byte{
	...
	0xc5, 0x0f, 0x0a, 0x0e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x73, 0x75, 0x6c, 0x74, 0x1a, 0x8a, 0x04, 0x0a, 0x0b, 0x44, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73,
	...
	0x01, 0x1a, 0x85, 0x07, 0x0a, 0x03, 0x48, 0x69, 0x74, 0x12, 0x20, 0x0a, 0x0b, 0x6c, 0x75, 0x63,
	...
	0xdb, 0x02, 0x0a, 0x0a, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x1e,
	...
	0x63, 0x74, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x2a, 0x25, 0x0a, 0x0d, 0x4d, 0x61,
	...
	0x4c, 0x45, 0x5f, 0x4d, 0x41, 0x58, 0x10, 0x03, 0x42, 0x3d, 0x0a, 0x1e, 0x63, 0x6f, 0x6d, 0x2e,
...
var file_yelp_nrtsearch_search_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_yelp_nrtsearch_search_proto_goTypes = []interface{}{
	...
	nil,                                            // 53: luceneserver.SearchResponse.Diagnostics.FacetTimeMsEntry
	(*SearchResponse_Hit_FieldValue)(nil),          // 54: luceneserver.SearchResponse.Hit.FieldValue
	(*SearchResponse_Hit_CompositeFieldValue)(nil), // 55: luceneserver.SearchResponse.Hit.CompositeFieldValue
	nil,                    // 56: luceneserver.SearchResponse.Hit.FieldsEntry
	nil,                    // 57: luceneserver.SearchResponse.Hit.SortedFieldsEntry
	(*Analyzer)(nil),       // 58: luceneserver.Analyzer
	(*latlng.LatLng)(nil),  // 59: google.type.LatLng
...
var file_yelp_nrtsearch_search_proto_depIdxs = []int32{
	...
	58, // 14: luceneserver.MatchQuery.analyzer:type_name -> luceneserver.Analyzer
	8,  // 15: luceneserver.MatchQuery.fuzzyParams:type_name -> luceneserver.FuzzyParams
	58, // 16: luceneserver.MatchPhraseQuery.analyzer:type_name -> luceneserver.Analyzer
	...
	58, // 19: luceneserver.MultiMatchQuery.analyzer:type_name -> luceneserver.Analyzer
	8,  // 20: luceneserver.MultiMatchQuery.fuzzyParams:type_name -> luceneserver.FuzzyParams
	59, // 21: luceneserver.GeoBoundingBoxQuery.topLeft:type_name -> google.type.LatLng
	59, // 22: luceneserver.GeoBoundingBoxQuery.bottomRight:type_name -> google.type.LatLng
	59, // 23: luceneserver.GeoRadiusQuery.center:type_name -> google.type.LatLng
	59, // 24: luceneserver.GeoPointQuery.point:type_name -> google.type.LatLng
	...
	60, // 61: luceneserver.FetchTask.params:type_name -> google.protobuf.Struct
	...
	53, // 69: luceneserver.SearchResponse.Diagnostics.facetTimeMs:type_name -> luceneserver.SearchResponse.Diagnostics.FacetTimeMsEntry
	56, // 70: luceneserver.SearchResponse.Hit.fields:type_name -> luceneserver.SearchResponse.Hit.FieldsEntry
	57, // 71: luceneserver.SearchResponse.Hit.sortedFields:type_name -> luceneserver.SearchResponse.Hit.SortedFieldsEntry
	59, // 72: luceneserver.SearchResponse.Hit.FieldValue.latLngValue:type_name -> google.type.LatLng
	60, // 73: luceneserver.SearchResponse.Hit.FieldValue.structValue:type_name -> google.protobuf.Struct
	54, // 74: luceneserver.SearchResponse.Hit.CompositeFieldValue.fieldValue:type_name -> luceneserver.SearchResponse.Hit.FieldValue
	55, // 75: luceneserver.SearchResponse.Hit.FieldsEntry.value:type_name -> luceneserver.SearchResponse.Hit.CompositeFieldValue
	55, // 76: luceneserver.SearchResponse.Hit.SortedFieldsEntry.value:type_name -> luceneserver.SearchResponse.Hit.CompositeFieldValue
