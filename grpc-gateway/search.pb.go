...
type SearchRequest struct {
	...
	Collectors         map[string]*Collector    `protobuf:"bytes,15,rep,name=collectors,proto3" json:"collectors,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type Collector_Max struct {
	Max *MaxCollector `protobuf:"bytes,1,opt,name=max,proto3,oneof"` //Collector for getting the max value of a field.
}
...
type MaxCollector struct {
	...
	Field string `protobuf:"bytes,1,opt,name=field,proto3" json:"field,omitempty"` //Field to find max of, must be Sortable.
}
...
func (x *MaxCollector) GetField() string {
	if x != nil {
		return x.Field
	}
	return ""
...
func (x *CollectorResult) GetMax() *MaxCollectorResult {
	if x, ok := x.GetCollectorResults().(*CollectorResult_Max); ok {
		return x.Max
	}
	return nil
}
...
type CollectorResult_Max struct {
	Max *MaxCollectorResult `protobuf:"bytes,1,opt,name=max,proto3,oneof"` //Resulting value of max value collection.
}

func (*CollectorResult_Max) isCollectorResult_CollectorResults() {}

type MaxCollectorResult struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to ResultValue:
	//	*MaxCollectorResult_IntValue
	//	*MaxCollectorResult_LongValue
	//	*MaxCollectorResult_FloatValue
	//	*MaxCollectorResult_DoubleValue
	ResultValue isMaxCollectorResult_ResultValue `protobuf_oneof:"ResultValue"`
}

func (x *MaxCollectorResult) Reset() {
	*x = MaxCollectorResult{}
	if protoimpl.UnsafeEnabled {
...
func (x *MaxCollectorResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MaxCollectorResult) ProtoMessage() {}

func (x *MaxCollectorResult) ProtoReflect() protoreflect.Message {
	mi := &file_yelp_nrtsearch_search_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MaxCollectorResult.ProtoReflect.Descriptor instead.
func (*MaxCollectorResult) Descriptor() ([]byte, []int) {
	return file_yelp_nrtsearch_search_proto_rawDescGZIP(), []int{29}
}

func (m *MaxCollectorResult) GetResultValue() isMaxCollectorResult_ResultValue {
	if m != nil {
...
func (x *MaxCollectorResult) GetIntValue() int32 {
	if x, ok := x.GetResultValue().(*MaxCollectorResult_IntValue); ok {
		return x.IntValue
	}
	return 0
}

func (x *MaxCollectorResult) GetLongValue() int64 {
	if x, ok := x.GetResultValue().(*MaxCollectorResult_LongValue); ok {
		return x.LongValue
	}
	return 0
}

func (x *MaxCollectorResult) GetFloatValue() float32 {
	if x, ok := x.GetResultValue().(*MaxCollectorResult_FloatValue); ok {
		return x.FloatValue
	}
	return 0
}

func (x *MaxCollectorResult) GetDoubleValue() float64 {
	if x, ok := x.GetResultValue().(*MaxCollectorResult_DoubleValue); ok {
		return x.DoubleValue
	}
	return 0
}

type isMaxCollectorResult_ResultValue interface {
	isMaxCollectorResult_ResultValue()
}

type MaxCollectorResult_IntValue struct {
	IntValue int32 `protobuf:"varint,1,opt,name=intValue,proto3,oneof"` // Max value for INT FieldType
}

type MaxCollectorResult_LongValue struct {
	LongValue int64 `protobuf:"varint,2,opt,name=longValue,proto3,oneof"` // Max value for LONG and DATE_TIME (as milliseconds since epoch in UTC zone) FieldType
}

type MaxCollectorResult_FloatValue struct {
	FloatValue float32 `protobuf:"fixed32,3,opt,name=floatValue,proto3,oneof"` // Max value for FLOAT FieldType
}

type MaxCollectorResult_DoubleValue struct {
	DoubleValue float64 `protobuf:"fixed64,4,opt,name=doubleValue,proto3,oneof"` // Max value for DOUBLE FieldType
}

func (*MaxCollectorResult_IntValue) isMaxCollectorResult_ResultValue() {}

func (*MaxCollectorResult_LongValue) isMaxCollectorResult_ResultValue() {}

func (*MaxCollectorResult_FloatValue) isMaxCollectorResult_ResultValue() {}

func (*MaxCollectorResult_DoubleValue) isMaxCollectorResult_ResultValue() {}
...
var file_yelp_nrtsearch_search_proto_rawDesc = []byte{
	...
	0x51, 0x75, 0x65, 0x72, 0x79, 0x4e, 0x6f, 0x64, 0x65, 0x22, 0xd8, 0x05, 0x0a, 0x0d, 0x53, 0x65,
	...
	0x65, 0x74, 0x73, 0x12, 0x4b, 0x0a, 0x0a, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72,
	0x73, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x6c, 0x75, 0x63, 0x65, 0x6e, 0x65,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x2e, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x73, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x52, 0x0a, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x73,
	...
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xb2, 0x03, 0x0a, 0x06, 0x53, 0x63, 0x72, 0x69, 0x70,
	...
	0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x1a, 0xe5, 0x01, 0x0a, 0x0a, 0x50, 0x61, 0x72, 0x61,
	...
	,
	...
	0xaf, 0x0f, 0x0a, 0x0e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x4a, 0x0a, 0x0b, 0x64, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63,
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x6c, 0x75, 0x63, 0x65, 0x6e, 0x65,
	...
	0x73, 0x52, 0x0b, 0x64, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x73, 0x12, 0x1e,
	0x0a, 0x0a, 0x68, 0x69, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x0a, 0x68, 0x69, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x35,
	...
	0x65, 0x2e, 0x48, 0x69, 0x74, 0x52, 0x04, 0x68, 0x69, 0x74, 0x73, 0x12, 0x4a, 0x0a, 0x0b, 0x73,
	0x65, 0x61, 0x72, 0x63, 0x68, 0x53, 0x74, 0x61, 0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	...
	0x65, 0x61, 0x72, 0x63, 0x68, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x0b, 0x73, 0x65, 0x61, 0x72,
	0x63, 0x68, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x3b, 0x0a, 0x0b, 0x66, 0x61, 0x63, 0x65, 0x74,
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6c,
	...
	,
	...
	0x6d, 0x65, 0x4d, 0x73, 0x1a, 0xc8, 0x06, 0x0a, 0x03, 0x48, 0x69, 0x74, 0x12, 0x20, 0x0a, 0x0b,
	...
	0x64, 0x73, 0x1a, 0x9e, 0x02, 0x0a, 0x0a, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x56, 0x61, 0x6c, 0x75,
	...
	0x6e, 0x63, 0x6c, 0x75, 0x73, 0x69, 0x76, 0x65, 0x22, 0xc3, 0x01, 0x0a, 0x05, 0x46, 0x61, 0x63,
	...
	0x70, 0x4e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x74, 0x6f, 0x70, 0x4e, 0x22, 0xa8,
	...
	0x68, 0x69, 0x6c, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x3b, 0x0a, 0x0d, 0x4c, 0x61, 0x62,
	0x65, 0x6c, 0x41, 0x6e, 0x64, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61,
	0x62, 0x65, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c,
	0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x01, 0x52,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x49, 0x0a, 0x09, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63,
	0x74, 0x6f, 0x72, 0x12, 0x2e, 0x0a, 0x03, 0x6d, 0x61, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	...
	,
	...
	0x0d, 0x0a, 0x0b, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x2a, 0x25,
	...
	0x55, 0x53, 0x54, 0x10, 0x01, 0x2a, 0xc9, 0x01, 0x0a, 0x09, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54,
	...
	0x0a, 0x2a, 0x3c, 0x0a, 0x08, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x07, 0x0a,
	...
	0x3d, 0x0a, 0x1e, 0x63, 0x6f, 0x6d, 0x2e, 0x79, 0x65, 0x6c, 0x70, 0x2e, 0x6e, 0x72, 0x74, 0x73,
	...
	0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0xa2, 0x02, 0x03, 0x48, 0x4c, 0x57, 0x62, 0x06,
...
var file_yelp_nrtsearch_search_proto_msgTypes = make([]protoimpl.MessageInfo, 47)
var file_yelp_nrtsearch_search_proto_goTypes = []interface{}{
	...
	(*Collector)(nil),                     // 31: luceneserver.Collector
	(*MaxCollector)(nil),                  // 32: luceneserver.MaxCollector
	(*CollectorResult)(nil),               // 33: luceneserver.CollectorResult
	(*MaxCollectorResult)(nil),            // 34: luceneserver.MaxCollectorResult
	(*TermInSetQuery_TextTerms)(nil),      // 35: luceneserver.TermInSetQuery.TextTerms
	(*TermInSetQuery_IntTerms)(nil),       // 36: luceneserver.TermInSetQuery.IntTerms
	(*TermInSetQuery_LongTerms)(nil),      // 37: luceneserver.TermInSetQuery.LongTerms
	(*TermInSetQuery_FloatTerms)(nil),     // 38: luceneserver.TermInSetQuery.FloatTerms
	(*TermInSetQuery_DoubleTerms)(nil),    // 39: luceneserver.TermInSetQuery.DoubleTerms
	nil,                                   // 40: luceneserver.MultiMatchQuery.FieldBoostsEntry
	nil,                                   // 41: luceneserver.SearchRequest.CollectorsEntry
	(*Script_ParamValue)(nil),             // 42: luceneserver.Script.ParamValue
	nil,                                   // 43: luceneserver.Script.ParamsEntry
	(*SearchResponse_Diagnostics)(nil),    // 44: luceneserver.SearchResponse.Diagnostics
	(*SearchResponse_Hit)(nil),            // 45: luceneserver.SearchResponse.Hit
	(*SearchResponse_SearchState)(nil),    // 46: luceneserver.SearchResponse.SearchState
	nil,                                   // 47: luceneserver.SearchResponse.CollectorResultsEntry
...
var file_yelp_nrtsearch_search_proto_depIdxs = []int32{
	...
	35, // 5: luceneserver.TermInSetQuery.textTerms:type_name -> luceneserver.TermInSetQuery.TextTerms
	36, // 6: luceneserver.TermInSetQuery.intTerms:type_name -> luceneserver.TermInSetQuery.IntTerms
	37, // 7: luceneserver.TermInSetQuery.longTerms:type_name -> luceneserver.TermInSetQuery.LongTerms
	38, // 8: luceneserver.TermInSetQuery.floatTerms:type_name -> luceneserver.TermInSetQuery.FloatTerms
	39, // 9: luceneserver.TermInSetQuery.doubleTerms:type_name -> luceneserver.TermInSetQuery.DoubleTerms
	...
	40, // 15: luceneserver.MultiMatchQuery.fieldBoosts:type_name -> luceneserver.MultiMatchQuery.FieldBoostsEntry
	...
	41, // 34: luceneserver.SearchRequest.collectors:type_name -> luceneserver.SearchRequest.CollectorsEntry
	20, // 35: luceneserver.VirtualField.script:type_name -> luceneserver.Script
	43, // 36: luceneserver.Script.params:type_name -> luceneserver.Script.ParamsEntry
	22, // 37: luceneserver.QuerySortField.fields:type_name -> luceneserver.SortFields
	23, // 38: luceneserver.SortFields.sortedFields:type_name -> luceneserver.SortType
	2,  // 39: luceneserver.SortType.selector:type_name -> luceneserver.Selector
	25, // 40: luceneserver.SortType.origin:type_name -> luceneserver.Point
	4,  // 41: luceneserver.TotalHits.relation:type_name -> luceneserver.TotalHits.Relation
	44, // 42: luceneserver.SearchResponse.diagnostics:type_name -> luceneserver.SearchResponse.Diagnostics
	24, // 43: luceneserver.SearchResponse.totalHits:type_name -> luceneserver.TotalHits
	45, // 44: luceneserver.SearchResponse.hits:type_name -> luceneserver.SearchResponse.Hit
	46, // 45: luceneserver.SearchResponse.searchState:type_name -> luceneserver.SearchResponse.SearchState
	29, // 46: luceneserver.SearchResponse.facetResult:type_name -> luceneserver.FacetResult
	47, // 47: luceneserver.SearchResponse.collectorResults:type_name -> luceneserver.SearchResponse.CollectorResultsEntry
	27, // 48: luceneserver.Facet.numericRange:type_name -> luceneserver.NumericRangeType
	30, // 49: luceneserver.FacetResult.labelValues:type_name -> luceneserver.LabelAndValue
	32, // 50: luceneserver.Collector.max:type_name -> luceneserver.MaxCollector
	34, // 51: luceneserver.CollectorResult.max:type_name -> luceneserver.MaxCollectorResult
	31, // 52: luceneserver.SearchRequest.CollectorsEntry.value:type_name -> luceneserver.Collector
	42, // 53: luceneserver.Script.ParamsEntry.value:type_name -> luceneserver.Script.ParamValue
	50, // 54: luceneserver.SearchResponse.Hit.fields:type_name -> luceneserver.SearchResponse.Hit.FieldsEntry
	51, // 55: luceneserver.SearchResponse.Hit.sortedFields:type_name -> luceneserver.SearchResponse.Hit.SortedFieldsEntry
	33, // 56: luceneserver.SearchResponse.CollectorResultsEntry.value:type_name -> luceneserver.CollectorResult
	53, // 57: luceneserver.SearchResponse.Hit.FieldValue.latLngValue:type_name -> google.type.LatLng
	48, // 58: luceneserver.SearchResponse.Hit.CompositeFieldValue.fieldValue:type_name -> luceneserver.SearchResponse.Hit.FieldValue
	49, // 59: luceneserver.SearchResponse.Hit.FieldsEntry.value:type_name -> luceneserver.SearchResponse.Hit.CompositeFieldValue
	49, // 60: luceneserver.SearchResponse.Hit.SortedFieldsEntry.value:type_name -> luceneserver.SearchResponse.Hit.CompositeFieldValue
...
func file_yelp_nrtsearch_search_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_yelp_nrtsearch_search_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MaxCollectorResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_yelp_nrtsearch_search_proto_msgTypes[28].OneofWrappers = []interface{}{
		(*CollectorResult_Max)(nil),
	}
	file_yelp_nrtsearch_search_proto_msgTypes[29].OneofWrappers = []interface{}{
		(*MaxCollectorResult_IntValue)(nil),
		(*MaxCollectorResult_LongValue)(nil),
		(*MaxCollectorResult_FloatValue)(nil),
		(*MaxCollectorResult_DoubleValue)(nil),
	}
