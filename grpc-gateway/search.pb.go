...
// A query that wraps another query and uses custom scoring logic to filter out the the wrapped query's results.
...
func (x *FunctionFilterQuery) GetQuery() *Query {
	if x != nil {
		return x.Query
	}
	return nil
...
var file_yelp_nrtsearch_search_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0x6e, 0x0a, 0x13, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x46, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x29, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x72,
	0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6c, 0x75, 0x63, 0x65, 0x6e, 0x65,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x05, 0x71, 0x75,
	0x65, 0x72, 0x79, 0x12, 0x2c, 0x0a, 0x06, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6c, 0x75, 0x63, 0x65, 0x6e, 0x65, 0x73, 0x65, 0x72, 0x76,
	...
	0x0b, 0x0a, 0x09, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4e, 0x6f, 0x64, 0x65, 0x22, 0xce, 0x05, 0x0a,
	...
	0x68, 0x42, 0x0a, 0x0a, 0x08, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x65, 0x72, 0x22, 0x50, 0x0a,
	...
	0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x22, 0xc5, 0x0f, 0x0a, 0x0e, 0x53, 0x65, 0x61, 0x72, 0x63,
	...
	0x66, 0x61, 0x63, 0x65, 0x74, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x1a, 0x8a, 0x04, 0x0a, 0x0b,
	0x44, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x73, 0x12, 0x20, 0x0a, 0x0b, 0x70,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x72, 0x65, 0x77, 0x72, 0x69, 0x74, 0x74, 0x65, 0x6e,
	0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x26, 0x0a, 0x0e, 0x64, 0x72, 0x69, 0x6c, 0x6c, 0x44, 0x6f,
	0x77, 0x6e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x64,
	...
	0x65, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x4d, 0x73, 0x1a, 0x3e, 0x0a, 0x10, 0x46, 0x61, 0x63, 0x65,
	...
	0x73, 0x2a, 0x25, 0x0a, 0x0d, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74,
	0x6f, 0x72, 0x12, 0x0a, 0x0a, 0x06, 0x53, 0x48, 0x4f, 0x55, 0x4c, 0x44, 0x10, 0x00, 0x12, 0x08,
	0x0a, 0x04, 0x4d, 0x55, 0x53, 0x54, 0x10, 0x01, 0x2a, 0x96, 0x02, 0x0a, 0x09, 0x51, 0x75, 0x65,
	...
	0x0f, 0x2a, 0x3c, 0x0a, 0x08, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x07, 0x0a,
...
var file_yelp_nrtsearch_search_proto_depIdxs = []int32{
	...
	25, // 5: luceneserver.FunctionFilterQuery.query:type_name -> luceneserver.Query
	28, // 6: luceneserver.FunctionFilterQuery.script:type_name -> luceneserver.Script
	25, // 7: luceneserver.NestedQuery.query:type_name -> luceneserver.Query
	4,  // 8: luceneserver.NestedQuery.scoreMode:type_name -> luceneserver.NestedQuery.ScoreMode
	40, // 9: luceneserver.TermInSetQuery.textTerms:type_name -> luceneserver.TermInSetQuery.TextTerms
	41, // 10: luceneserver.TermInSetQuery.intTerms:type_name -> luceneserver.TermInSetQuery.IntTerms
	42, // 11: luceneserver.TermInSetQuery.longTerms:type_name -> luceneserver.TermInSetQuery.LongTerms
	43, // 12: luceneserver.TermInSetQuery.floatTerms:type_name -> luceneserver.TermInSetQuery.FloatTerms
	44, // 13: luceneserver.TermInSetQuery.doubleTerms:type_name -> luceneserver.TermInSetQuery.DoubleTerms
	25, // 14: luceneserver.DisjunctionMaxQuery.disjuncts:type_name -> luceneserver.Query
	0,  // 15: luceneserver.MatchQuery.operator:type_name -> luceneserver.MatchOperator
	59, // 16: luceneserver.MatchQuery.analyzer:type_name -> luceneserver.Analyzer
	8,  // 17: luceneserver.MatchQuery.fuzzyParams:type_name -> luceneserver.FuzzyParams
	59, // 18: luceneserver.MatchPhraseQuery.analyzer:type_name -> luceneserver.Analyzer
	45, // 19: luceneserver.MultiMatchQuery.fieldBoosts:type_name -> luceneserver.MultiMatchQuery.FieldBoostsEntry
	0,  // 20: luceneserver.MultiMatchQuery.operator:type_name -> luceneserver.MatchOperator
	59, // 21: luceneserver.MultiMatchQuery.analyzer:type_name -> luceneserver.Analyzer
	8,  // 22: luceneserver.MultiMatchQuery.fuzzyParams:type_name -> luceneserver.FuzzyParams
	60, // 23: luceneserver.GeoBoundingBoxQuery.topLeft:type_name -> google.type.LatLng
	60, // 24: luceneserver.GeoBoundingBoxQuery.bottomRight:type_name -> google.type.LatLng
	60, // 25: luceneserver.GeoRadiusQuery.center:type_name -> google.type.LatLng
	60, // 26: luceneserver.GeoPointQuery.point:type_name -> google.type.LatLng
	1,  // 27: luceneserver.Query.queryType:type_name -> luceneserver.QueryType
	9,  // 28: luceneserver.Query.booleanQuery:type_name -> luceneserver.BooleanQuery
	10, // 29: luceneserver.Query.phraseQuery:type_name -> luceneserver.PhraseQuery
	11, // 30: luceneserver.Query.functionScoreQuery:type_name -> luceneserver.FunctionScoreQuery
	14, // 31: luceneserver.Query.termQuery:type_name -> luceneserver.TermQuery
	15, // 32: luceneserver.Query.termInSetQuery:type_name -> luceneserver.TermInSetQuery
	16, // 33: luceneserver.Query.disjunctionMaxQuery:type_name -> luceneserver.DisjunctionMaxQuery
	17, // 34: luceneserver.Query.matchQuery:type_name -> luceneserver.MatchQuery
	18, // 35: luceneserver.Query.matchPhraseQuery:type_name -> luceneserver.MatchPhraseQuery
	19, // 36: luceneserver.Query.multiMatchQuery:type_name -> luceneserver.MultiMatchQuery
	20, // 37: luceneserver.Query.rangeQuery:type_name -> luceneserver.RangeQuery
	21, // 38: luceneserver.Query.geoBoundingBoxQuery:type_name -> luceneserver.GeoBoundingBoxQuery
	23, // 39: luceneserver.Query.geoPointQuery:type_name -> luceneserver.GeoPointQuery
	13, // 40: luceneserver.Query.nestedQuery:type_name -> luceneserver.NestedQuery
	24, // 41: luceneserver.Query.existsQuery:type_name -> luceneserver.ExistsQuery
	22, // 42: luceneserver.Query.geoRadiusQuery:type_name -> luceneserver.GeoRadiusQuery
	12, // 43: luceneserver.Query.functionFilterQuery:type_name -> luceneserver.FunctionFilterQuery
	27, // 44: luceneserver.SearchRequest.virtualFields:type_name -> luceneserver.VirtualField
	25, // 45: luceneserver.SearchRequest.query:type_name -> luceneserver.Query
	29, // 46: luceneserver.SearchRequest.querySort:type_name -> luceneserver.QuerySortField
	36, // 47: luceneserver.SearchRequest.facets:type_name -> luceneserver.Facet
	39, // 48: luceneserver.SearchRequest.fetchTasks:type_name -> luceneserver.FetchTask
	28, // 49: luceneserver.VirtualField.script:type_name -> luceneserver.Script
	49, // 50: luceneserver.Script.params:type_name -> luceneserver.Script.ParamsEntry
	...
	51, // 56: luceneserver.SearchResponse.diagnostics:type_name -> luceneserver.SearchResponse.Diagnostics
	32, // 57: luceneserver.SearchResponse.totalHits:type_name -> luceneserver.TotalHits
	52, // 58: luceneserver.SearchResponse.hits:type_name -> luceneserver.SearchResponse.Hit
	53, // 59: luceneserver.SearchResponse.searchState:type_name -> luceneserver.SearchResponse.SearchState
	...
	61, // 64: luceneserver.FetchTask.params:type_name -> google.protobuf.Struct
	5,  // 65: luceneserver.Script.ParamValue.nullValue:type_name -> luceneserver.Script.ParamNullValue
	48, // 66: luceneserver.Script.ParamValue.listValue:type_name -> luceneserver.Script.ParamListValue
	47, // 67: luceneserver.Script.ParamValue.structValue:type_name -> luceneserver.Script.ParamStructValue
	50, // 68: luceneserver.Script.ParamStructValue.fields:type_name -> luceneserver.Script.ParamStructValue.FieldsEntry
	46, // 69: luceneserver.Script.ParamListValue.values:type_name -> luceneserver.Script.ParamValue
	46, // 70: luceneserver.Script.ParamsEntry.value:type_name -> luceneserver.Script.ParamValue
	46, // 71: luceneserver.Script.ParamStructValue.FieldsEntry.value:type_name -> luceneserver.Script.ParamValue
	54, // 72: luceneserver.SearchResponse.Diagnostics.facetTimeMs:type_name -> luceneserver.SearchResponse.Diagnostics.FacetTimeMsEntry
	57, // 73: luceneserver.SearchResponse.Hit.fields:type_name -> luceneserver.SearchResponse.Hit.FieldsEntry
	58, // 74: luceneserver.SearchResponse.Hit.sortedFields:type_name -> luceneserver.SearchResponse.Hit.SortedFieldsEntry
	60, // 75: luceneserver.SearchResponse.Hit.FieldValue.latLngValue:type_name -> google.type.LatLng
	61, // 76: luceneserver.SearchResponse.Hit.FieldValue.structValue:type_name -> google.protobuf.Struct
	55, // 77: luceneserver.SearchResponse.Hit.CompositeFieldValue.fieldValue:type_name -> luceneserver.SearchResponse.Hit.FieldValue
	56, // 78: luceneserver.SearchResponse.Hit.FieldsEntry.value:type_name -> luceneserver.SearchResponse.Hit.CompositeFieldValue
	56, // 79: luceneserver.SearchResponse.Hit.SortedFieldsEntry.value:type_name -> luceneserver.SearchResponse.Hit.CompositeFieldValue
