...
func (*SearchResponse_Hit_Highlights) Descriptor() ([]byte, []int) {
	return file_yelp_nrtsearch_search_proto_rawDescGZIP(), []int{27, 1, 2}
}
...
var file_yelp_nrtsearch_search_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x48, 0x69, 0x74, 0x52, 0x04, 0x68, 0x69, 0x74, 0x73, 0x22, 0xa2, 0x05, 0x0a, 0x09,
	...
	0x67, 0x73, 0x1a, 0xe1, 0x02, 0x0a, 0x08, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x12,
	...
	0x74, 0x51, 0x75, 0x65, 0x72, 0x79, 0x1a, 0x62, 0x0a, 0x12, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x53,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x24, 0x0a, 0x04, 0x54, 0x79,
	...
	0x2a, 0x25, 0x0a, 0x0d, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f,
	0x72, 0x12, 0x0a, 0x0a, 0x06, 0x53, 0x48, 0x4f, 0x55, 0x4c, 0x44, 0x10, 0x00, 0x12, 0x08, 0x0a,
	0x04, 0x4d, 0x55, 0x53, 0x54, 0x10, 0x01, 0x2a, 0x96, 0x02, 0x0a, 0x09, 0x51, 0x75, 0x65, 0x72,
...
var file_yelp_nrtsearch_search_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
var file_yelp_nrtsearch_search_proto_msgTypes = make([]protoimpl.MessageInfo, 80)
var file_yelp_nrtsearch_search_proto_goTypes = []interface{}{
	...
	(Highlight_Type)(0),                   // 7: luceneserver.Highlight.Type
	(*BooleanClause)(nil),                 // 8: luceneserver.BooleanClause
	(*FuzzyParams)(nil),                   // 9: luceneserver.FuzzyParams
	(*BooleanQuery)(nil),                  // 10: luceneserver.BooleanQuery
	(*PhraseQuery)(nil),                   // 11: luceneserver.PhraseQuery
	(*FunctionScoreQuery)(nil),            // 12: luceneserver.FunctionScoreQuery
	(*FunctionFilterQuery)(nil),           // 13: luceneserver.FunctionFilterQuery
	(*NestedQuery)(nil),                   // 14: luceneserver.NestedQuery
	(*TermQuery)(nil),                     // 15: luceneserver.TermQuery
	(*TermInSetQuery)(nil),                // 16: luceneserver.TermInSetQuery
	(*DisjunctionMaxQuery)(nil),           // 17: luceneserver.DisjunctionMaxQuery
	(*MatchQuery)(nil),                    // 18: luceneserver.MatchQuery
	(*MatchPhraseQuery)(nil),              // 19: luceneserver.MatchPhraseQuery
	(*MultiMatchQuery)(nil),               // 20: luceneserver.MultiMatchQuery
	(*RangeQuery)(nil),                    // 21: luceneserver.RangeQuery
	(*GeoBoundingBoxQuery)(nil),           // 22: luceneserver.GeoBoundingBoxQuery
	(*GeoRadiusQuery)(nil),                // 23: luceneserver.GeoRadiusQuery
	(*GeoPointQuery)(nil),                 // 24: luceneserver.GeoPointQuery
	(*ExistsQuery)(nil),                   // 25: luceneserver.ExistsQuery
	(*Query)(nil),                         // 26: luceneserver.Query
	(*SearchRequest)(nil),                 // 27: luceneserver.SearchRequest
	(*VirtualField)(nil),                  // 28: luceneserver.VirtualField
	(*Script)(nil),                        // 29: luceneserver.Script
	(*QuerySortField)(nil),                // 30: luceneserver.QuerySortField
	(*SortFields)(nil),                    // 31: luceneserver.SortFields
	(*SortType)(nil),                      // 32: luceneserver.SortType
	(*TotalHits)(nil),                     // 33: luceneserver.TotalHits
	(*Point)(nil),                         // 34: luceneserver.Point
	(*SearchResponse)(nil),                // 35: luceneserver.SearchResponse
	(*NumericRangeType)(nil),              // 36: luceneserver.NumericRangeType
	(*Facet)(nil),                         // 37: luceneserver.Facet
	(*FacetResult)(nil),                   // 38: luceneserver.FacetResult
	(*LabelAndValue)(nil),                 // 39: luceneserver.LabelAndValue
	(*FetchTask)(nil),                     // 40: luceneserver.FetchTask
	(*PluginRescorer)(nil),                // 41: luceneserver.PluginRescorer
	(*QueryRescorer)(nil),                 // 42: luceneserver.QueryRescorer
	(*Rescorer)(nil),                      // 43: luceneserver.Rescorer
	(*ProfileResult)(nil),                 // 44: luceneserver.ProfileResult
	(*Collector)(nil),                     // 45: luceneserver.Collector
	(*PluginCollector)(nil),               // 46: luceneserver.PluginCollector
	(*TermsCollector)(nil),                // 47: luceneserver.TermsCollector
	(*TopHitsCollector)(nil),              // 48: luceneserver.TopHitsCollector
	(*CollectorResult)(nil),               // 49: luceneserver.CollectorResult
	(*BucketResult)(nil),                  // 50: luceneserver.BucketResult
	(*HitsResult)(nil),                    // 51: luceneserver.HitsResult
	(*Highlight)(nil),                     // 52: luceneserver.Highlight
	(*TermInSetQuery_TextTerms)(nil),      // 53: luceneserver.TermInSetQuery.TextTerms
	(*TermInSetQuery_IntTerms)(nil),       // 54: luceneserver.TermInSetQuery.IntTerms
	(*TermInSetQuery_LongTerms)(nil),      // 55: luceneserver.TermInSetQuery.LongTerms
	(*TermInSetQuery_FloatTerms)(nil),     // 56: luceneserver.TermInSetQuery.FloatTerms
	(*TermInSetQuery_DoubleTerms)(nil),    // 57: luceneserver.TermInSetQuery.DoubleTerms
	nil,                                   // 58: luceneserver.MultiMatchQuery.FieldBoostsEntry
	nil,                                   // 59: luceneserver.SearchRequest.CollectorsEntry
	(*Script_ParamValue)(nil),             // 60: luceneserver.Script.ParamValue
	(*Script_ParamStructValue)(nil),       // 61: luceneserver.Script.ParamStructValue
	(*Script_ParamListValue)(nil),         // 62: luceneserver.Script.ParamListValue
	nil,                                   // 63: luceneserver.Script.ParamsEntry
	nil,                                   // 64: luceneserver.Script.ParamStructValue.FieldsEntry
	(*SearchResponse_Diagnostics)(nil),    // 65: luceneserver.SearchResponse.Diagnostics
	(*SearchResponse_Hit)(nil),            // 66: luceneserver.SearchResponse.Hit
	(*SearchResponse_SearchState)(nil),    // 67: luceneserver.SearchResponse.SearchState
	nil,                                   // 68: luceneserver.SearchResponse.CollectorResultsEntry
	nil,                                   // 69: luceneserver.SearchResponse.Diagnostics.FacetTimeMsEntry
	nil,                                   // 70: luceneserver.SearchResponse.Diagnostics.RescorersTimeMsEntry
	(*SearchResponse_Hit_FieldValue)(nil), // 71: luceneserver.SearchResponse.Hit.FieldValue
	(*SearchResponse_Hit_CompositeFieldValue)(nil), // 72: luceneserver.SearchResponse.Hit.CompositeFieldValue
	(*SearchResponse_Hit_Highlights)(nil),          // 73: luceneserver.SearchResponse.Hit.Highlights
	nil,                                            // 74: luceneserver.SearchResponse.Hit.FieldsEntry
	nil,                                            // 75: luceneserver.SearchResponse.Hit.SortedFieldsEntry
	nil,                                            // 76: luceneserver.SearchResponse.Hit.HighlightsEntry
	(*SearchResponse_Hit_FieldValue_Vector)(nil),   // 77: luceneserver.SearchResponse.Hit.FieldValue.Vector
	(*ProfileResult_AdditionalCollectorStats)(nil), // 78: luceneserver.ProfileResult.AdditionalCollectorStats
	(*ProfileResult_CollectorStats)(nil),           // 79: luceneserver.ProfileResult.CollectorStats
	(*ProfileResult_SegmentStats)(nil),             // 80: luceneserver.ProfileResult.SegmentStats
	(*ProfileResult_SearchStats)(nil),              // 81: luceneserver.ProfileResult.SearchStats
	nil,                                            // 82: luceneserver.ProfileResult.CollectorStats.AdditionalCollectorStatsEntry
	nil,                                            // 83: luceneserver.Collector.NestedCollectorsEntry
	(*BucketResult_Bucket)(nil),                    // 84: luceneserver.BucketResult.Bucket
	nil,                                            // 85: luceneserver.BucketResult.Bucket.NestedCollectorResultsEntry
	(*Highlight_Settings)(nil),                     // 86: luceneserver.Highlight.Settings
	nil,                                            // 87: luceneserver.Highlight.FieldSettingsEntry
	(*Analyzer)(nil),                               // 88: luceneserver.Analyzer
	(*latlng.LatLng)(nil),                          // 89: google.type.LatLng
	(*structpb.Struct)(nil),                        // 90: google.protobuf.Struct
	(*anypb.Any)(nil),                              // 91: google.protobuf.Any
	(*wrapperspb.UInt32Value)(nil),                 // 92: google.protobuf.UInt32Value
}
var file_yelp_nrtsearch_search_proto_depIdxs = []int32{
	26,  // 0: luceneserver.BooleanClause.query:type_name -> luceneserver.Query
	3,   // 1: luceneserver.BooleanClause.occur:type_name -> luceneserver.BooleanClause.Occur
	8,   // 2: luceneserver.BooleanQuery.clauses:type_name -> luceneserver.BooleanClause
	26,  // 3: luceneserver.FunctionScoreQuery.query:type_name -> luceneserver.Query
	29,  // 4: luceneserver.FunctionScoreQuery.script:type_name -> luceneserver.Script
	29,  // 5: luceneserver.FunctionFilterQuery.script:type_name -> luceneserver.Script
	26,  // 6: luceneserver.NestedQuery.query:type_name -> luceneserver.Query
	4,   // 7: luceneserver.NestedQuery.scoreMode:type_name -> luceneserver.NestedQuery.ScoreMode
	53,  // 8: luceneserver.TermInSetQuery.textTerms:type_name -> luceneserver.TermInSetQuery.TextTerms
	54,  // 9: luceneserver.TermInSetQuery.intTerms:type_name -> luceneserver.TermInSetQuery.IntTerms
	55,  // 10: luceneserver.TermInSetQuery.longTerms:type_name -> luceneserver.TermInSetQuery.LongTerms
	56,  // 11: luceneserver.TermInSetQuery.floatTerms:type_name -> luceneserver.TermInSetQuery.FloatTerms
	57,  // 12: luceneserver.TermInSetQuery.doubleTerms:type_name -> luceneserver.TermInSetQuery.DoubleTerms
	26,  // 13: luceneserver.DisjunctionMaxQuery.disjuncts:type_name -> luceneserver.Query
	0,   // 14: luceneserver.MatchQuery.operator:type_name -> luceneserver.MatchOperator
	88,  // 15: luceneserver.MatchQuery.analyzer:type_name -> luceneserver.Analyzer
	9,   // 16: luceneserver.MatchQuery.fuzzyParams:type_name -> luceneserver.FuzzyParams
	88,  // 17: luceneserver.MatchPhraseQuery.analyzer:type_name -> luceneserver.Analyzer
	58,  // 18: luceneserver.MultiMatchQuery.fieldBoosts:type_name -> luceneserver.MultiMatchQuery.FieldBoostsEntry
	0,   // 19: luceneserver.MultiMatchQuery.operator:type_name -> luceneserver.MatchOperator
	88,  // 20: luceneserver.MultiMatchQuery.analyzer:type_name -> luceneserver.Analyzer
	9,   // 21: luceneserver.MultiMatchQuery.fuzzyParams:type_name -> luceneserver.FuzzyParams
	89,  // 22: luceneserver.GeoBoundingBoxQuery.topLeft:type_name -> google.type.LatLng
	89,  // 23: luceneserver.GeoBoundingBoxQuery.bottomRight:type_name -> google.type.LatLng
	89,  // 24: luceneserver.GeoRadiusQuery.center:type_name -> google.type.LatLng
	89,  // 25: luceneserver.GeoPointQuery.point:type_name -> google.type.LatLng
	1,   // 26: luceneserver.Query.queryType:type_name -> luceneserver.QueryType
	10,  // 27: luceneserver.Query.booleanQuery:type_name -> luceneserver.BooleanQuery
	11,  // 28: luceneserver.Query.phraseQuery:type_name -> luceneserver.PhraseQuery
	12,  // 29: luceneserver.Query.functionScoreQuery:type_name -> luceneserver.FunctionScoreQuery
	15,  // 30: luceneserver.Query.termQuery:type_name -> luceneserver.TermQuery
	16,  // 31: luceneserver.Query.termInSetQuery:type_name -> luceneserver.TermInSetQuery
	17,  // 32: luceneserver.Query.disjunctionMaxQuery:type_name -> luceneserver.DisjunctionMaxQuery
	18,  // 33: luceneserver.Query.matchQuery:type_name -> luceneserver.MatchQuery
	19,  // 34: luceneserver.Query.matchPhraseQuery:type_name -> luceneserver.MatchPhraseQuery
	20,  // 35: luceneserver.Query.multiMatchQuery:type_name -> luceneserver.MultiMatchQuery
	21,  // 36: luceneserver.Query.rangeQuery:type_name -> luceneserver.RangeQuery
	22,  // 37: luceneserver.Query.geoBoundingBoxQuery:type_name -> luceneserver.GeoBoundingBoxQuery
	24,  // 38: luceneserver.Query.geoPointQuery:type_name -> luceneserver.GeoPointQuery
	14,  // 39: luceneserver.Query.nestedQuery:type_name -> luceneserver.NestedQuery
	25,  // 40: luceneserver.Query.existsQuery:type_name -> luceneserver.ExistsQuery
	23,  // 41: luceneserver.Query.geoRadiusQuery:type_name -> luceneserver.GeoRadiusQuery
	13,  // 42: luceneserver.Query.functionFilterQuery:type_name -> luceneserver.FunctionFilterQuery
	28,  // 43: luceneserver.SearchRequest.virtualFields:type_name -> luceneserver.VirtualField
	26,  // 44: luceneserver.SearchRequest.query:type_name -> luceneserver.Query
	30,  // 45: luceneserver.SearchRequest.querySort:type_name -> luceneserver.QuerySortField
	37,  // 46: luceneserver.SearchRequest.facets:type_name -> luceneserver.Facet
	40,  // 47: luceneserver.SearchRequest.fetchTasks:type_name -> luceneserver.FetchTask
	43,  // 48: luceneserver.SearchRequest.rescorers:type_name -> luceneserver.Rescorer
	59,  // 49: luceneserver.SearchRequest.collectors:type_name -> luceneserver.SearchRequest.CollectorsEntry
	52,  // 50: luceneserver.SearchRequest.highlight:type_name -> luceneserver.Highlight
	29,  // 51: luceneserver.VirtualField.script:type_name -> luceneserver.Script
	63,  // 52: luceneserver.Script.params:type_name -> luceneserver.Script.ParamsEntry
	31,  // 53: luceneserver.QuerySortField.fields:type_name -> luceneserver.SortFields
	32,  // 54: luceneserver.SortFields.sortedFields:type_name -> luceneserver.SortType
	2,   // 55: luceneserver.SortType.selector:type_name -> luceneserver.Selector
	34,  // 56: luceneserver.SortType.origin:type_name -> luceneserver.Point
	6,   // 57: luceneserver.TotalHits.relation:type_name -> luceneserver.TotalHits.Relation
	65,  // 58: luceneserver.SearchResponse.diagnostics:type_name -> luceneserver.SearchResponse.Diagnostics
	33,  // 59: luceneserver.SearchResponse.totalHits:type_name -> luceneserver.TotalHits
	66,  // 60: luceneserver.SearchResponse.hits:type_name -> luceneserver.SearchResponse.Hit
	67,  // 61: luceneserver.SearchResponse.searchState:type_name -> luceneserver.SearchResponse.SearchState
	38,  // 62: luceneserver.SearchResponse.facetResult:type_name -> luceneserver.FacetResult
	44,  // 63: luceneserver.SearchResponse.profileResult:type_name -> luceneserver.ProfileResult
	68,  // 64: luceneserver.SearchResponse.collectorResults:type_name -> luceneserver.SearchResponse.CollectorResultsEntry
	36,  // 65: luceneserver.Facet.numericRange:type_name -> luceneserver.NumericRangeType
	29,  // 66: luceneserver.Facet.script:type_name -> luceneserver.Script
	39,  // 67: luceneserver.FacetResult.labelValues:type_name -> luceneserver.LabelAndValue
	90,  // 68: luceneserver.FetchTask.params:type_name -> google.protobuf.Struct
	90,  // 69: luceneserver.PluginRescorer.params:type_name -> google.protobuf.Struct
	26,  // 70: luceneserver.QueryRescorer.rescoreQuery:type_name -> luceneserver.Query
	42,  // 71: luceneserver.Rescorer.queryRescorer:type_name -> luceneserver.QueryRescorer
	41,  // 72: luceneserver.Rescorer.pluginRescorer:type_name -> luceneserver.PluginRescorer
	81,  // 73: luceneserver.ProfileResult.searchStats:type_name -> luceneserver.ProfileResult.SearchStats
	47,  // 74: luceneserver.Collector.terms:type_name -> luceneserver.TermsCollector
	46,  // 75: luceneserver.Collector.pluginCollector:type_name -> luceneserver.PluginCollector
	48,  // 76: luceneserver.Collector.topHitsCollector:type_name -> luceneserver.TopHitsCollector
	83,  // 77: luceneserver.Collector.nestedCollectors:type_name -> luceneserver.Collector.NestedCollectorsEntry
	90,  // 78: luceneserver.PluginCollector.params:type_name -> google.protobuf.Struct
	29,  // 79: luceneserver.TermsCollector.script:type_name -> luceneserver.Script
	30,  // 80: luceneserver.TopHitsCollector.querySort:type_name -> luceneserver.QuerySortField
	50,  // 81: luceneserver.CollectorResult.bucketResult:type_name -> luceneserver.BucketResult
	91,  // 82: luceneserver.CollectorResult.anyResult:type_name -> google.protobuf.Any
	51,  // 83: luceneserver.CollectorResult.hitsResult:type_name -> luceneserver.HitsResult
	84,  // 84: luceneserver.BucketResult.buckets:type_name -> luceneserver.BucketResult.Bucket
	33,  // 85: luceneserver.HitsResult.totalHits:type_name -> luceneserver.TotalHits
	66,  // 86: luceneserver.HitsResult.hits:type_name -> luceneserver.SearchResponse.Hit
	86,  // 87: luceneserver.Highlight.settings:type_name -> luceneserver.Highlight.Settings
	87,  // 88: luceneserver.Highlight.field_settings:type_name -> luceneserver.Highlight.FieldSettingsEntry
	45,  // 89: luceneserver.SearchRequest.CollectorsEntry.value:type_name -> luceneserver.Collector
	5,   // 90: luceneserver.Script.ParamValue.nullValue:type_name -> luceneserver.Script.ParamNullValue
	62,  // 91: luceneserver.Script.ParamValue.listValue:type_name -> luceneserver.Script.ParamListValue
	61,  // 92: luceneserver.Script.ParamValue.structValue:type_name -> luceneserver.Script.ParamStructValue
	64,  // 93: luceneserver.Script.ParamStructValue.fields:type_name -> luceneserver.Script.ParamStructValue.FieldsEntry
	60,  // 94: luceneserver.Script.ParamListValue.values:type_name -> luceneserver.Script.ParamValue
	60,  // 95: luceneserver.Script.ParamsEntry.value:type_name -> luceneserver.Script.ParamValue
	60,  // 96: luceneserver.Script.ParamStructValue.FieldsEntry.value:type_name -> luceneserver.Script.ParamValue
	69,  // 97: luceneserver.SearchResponse.Diagnostics.facetTimeMs:type_name -> luceneserver.SearchResponse.Diagnostics.FacetTimeMsEntry
	70,  // 98: luceneserver.SearchResponse.Diagnostics.rescorersTimeMs:type_name -> luceneserver.SearchResponse.Diagnostics.RescorersTimeMsEntry
	74,  // 99: luceneserver.SearchResponse.Hit.fields:type_name -> luceneserver.SearchResponse.Hit.FieldsEntry
	75,  // 100: luceneserver.SearchResponse.Hit.sortedFields:type_name -> luceneserver.SearchResponse.Hit.SortedFieldsEntry
	76,  // 101: luceneserver.SearchResponse.Hit.highlights:type_name -> luceneserver.SearchResponse.Hit.HighlightsEntry
	49,  // 102: luceneserver.SearchResponse.CollectorResultsEntry.value:type_name -> luceneserver.CollectorResult
	89,  // 103: luceneserver.SearchResponse.Hit.FieldValue.latLngValue:type_name -> google.type.LatLng
	90,  // 104: luceneserver.SearchResponse.Hit.FieldValue.structValue:type_name -> google.protobuf.Struct
	77,  // 105: luceneserver.SearchResponse.Hit.FieldValue.vectorValue:type_name -> luceneserver.SearchResponse.Hit.FieldValue.Vector
	71,  // 106: luceneserver.SearchResponse.Hit.CompositeFieldValue.fieldValue:type_name -> luceneserver.SearchResponse.Hit.FieldValue
	72,  // 107: luceneserver.SearchResponse.Hit.FieldsEntry.value:type_name -> luceneserver.SearchResponse.Hit.CompositeFieldValue
	72,  // 108: luceneserver.SearchResponse.Hit.SortedFieldsEntry.value:type_name -> luceneserver.SearchResponse.Hit.CompositeFieldValue
	73,  // 109: luceneserver.SearchResponse.Hit.HighlightsEntry.value:type_name -> luceneserver.SearchResponse.Hit.Highlights
	80,  // 110: luceneserver.ProfileResult.CollectorStats.segmentStats:type_name -> luceneserver.ProfileResult.SegmentStats
	82,  // 111: luceneserver.ProfileResult.CollectorStats.additionalCollectorStats:type_name -> luceneserver.ProfileResult.CollectorStats.AdditionalCollectorStatsEntry
	79,  // 112: luceneserver.ProfileResult.SearchStats.collectorStats:type_name -> luceneserver.ProfileResult.CollectorStats
	78,  // 113: luceneserver.ProfileResult.CollectorStats.AdditionalCollectorStatsEntry.value:type_name -> luceneserver.ProfileResult.AdditionalCollectorStats
	45,  // 114: luceneserver.Collector.NestedCollectorsEntry.value:type_name -> luceneserver.Collector
	85,  // 115: luceneserver.BucketResult.Bucket.nestedCollectorResults:type_name -> luceneserver.BucketResult.Bucket.NestedCollectorResultsEntry
	49,  // 116: luceneserver.BucketResult.Bucket.NestedCollectorResultsEntry.value:type_name -> luceneserver.CollectorResult
	7,   // 117: luceneserver.Highlight.Settings.highlighter_type:type_name -> luceneserver.Highlight.Type
	92,  // 118: luceneserver.Highlight.Settings.fragment_size:type_name -> google.protobuf.UInt32Value
	92,  // 119: luceneserver.Highlight.Settings.max_number_of_fragments:type_name -> google.protobuf.UInt32Value
	26,  // 120: luceneserver.Highlight.Settings.highlight_query:type_name -> luceneserver.Query
	86,  // 121: luceneserver.Highlight.FieldSettingsEntry.value:type_name -> luceneserver.Highlight.Settings
