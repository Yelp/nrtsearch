...
var file_yelp_nrtsearch_luceneserver_proto_rawDesc = []byte{
	...
	0x47, 0x45, 0x5f, 0x53, 0x55, 0x42, 0x4d, 0x49, 0x54, 0x54, 0x45, 0x44, 0x10, 0x01, 0x2a, 0xa2,
	...
	0x44, 0x10, 0x0c, 0x2a, 0x64, 0x0a, 0x0c, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x4f, 0x70, 0x74, 0x69,
	...
	0x0a, 0x07, 0x4f, 0x6e, 0x67, 0x6f, 0x69, 0x6e, 0x67, 0x10, 0x03, 0x32, 0xb9, 0x1a, 0x0a, 0x0c,
	...
	0x01, 0x2a, 0x12, 0x6f, 0x0a, 0x0e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x46, 0x69,
	...
	0x73, 0x3a, 0x01, 0x2a, 0x12, 0x6b, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x72, 0x74, 0x49, 0x6e, 0x64,
	...
	0x64, 0x65, 0x78, 0x3a, 0x01, 0x2a, 0x12, 0x73, 0x0a, 0x0c, 0x61, 0x64, 0x64, 0x44, 0x6f, 0x63,
	...
	0x64, 0x65, 0x78, 0x5f, 0x62, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x3a, 0x01, 0x2a, 0x12, 0x6f, 0x0a,
	...
	0x65, 0x72, 0x67, 0x65, 0x3a, 0x01, 0x2a, 0x32, 0xd1, 0x05, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x6c,
	...
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x3b, 0x0a, 0x1e, 0x63,
...
var file_yelp_nrtsearch_luceneserver_proto_depIdxs = []int32{
	...
	92, // 11: luceneserver.SettingsRequest.indexSort:type_name -> luceneserver.SortFields
	...
	88, // 14: luceneserver.AddDocumentRequest.fields:type_name -> luceneserver.AddDocumentRequest.FieldsEntry
	...
	83, // 36: luceneserver.GetNodesResponse.nodes:type_name -> luceneserver.NodeInfo
	93, // 37: luceneserver.DeleteByQueryRequest.query:type_name -> luceneserver.Query
	...
	87, // 40: luceneserver.AddDocumentRequest.FieldsEntry.value:type_name -> luceneserver.AddDocumentRequest.MultiValuedField
	...
	94, // 52: luceneserver.LuceneServer.search:input_type -> luceneserver.SearchRequest
	18, // 53: luceneserver.LuceneServer.delete:input_type -> luceneserver.AddDocumentRequest
	84, // 54: luceneserver.LuceneServer.deleteByQuery:input_type -> luceneserver.DeleteByQueryRequest
	...
	76, // 67: luceneserver.LuceneServer.ready:input_type -> luceneserver.ReadyCheckRequest
	95, // 68: luceneserver.LuceneServer.metrics:input_type -> google.protobuf.Empty
	58, // 69: luceneserver.LuceneServer.indices:input_type -> luceneserver.IndicesRequest
	85, // 70: luceneserver.LuceneServer.forceMerge:input_type -> luceneserver.ForceMergeRequest
	64, // 71: luceneserver.ReplicationServer.addReplicas:input_type -> luceneserver.AddReplicaRequest
	70, // 72: luceneserver.ReplicationServer.recvCopyState:input_type -> luceneserver.CopyStateRequest
	73, // 73: luceneserver.ReplicationServer.sendRawFile:input_type -> luceneserver.RawFileChunk
	72, // 74: luceneserver.ReplicationServer.recvRawFile:input_type -> luceneserver.FileInfo
	69, // 75: luceneserver.ReplicationServer.copyFiles:input_type -> luceneserver.CopyFiles
	78, // 76: luceneserver.ReplicationServer.newNRTPoint:input_type -> luceneserver.NewNRTPoint
	79, // 77: luceneserver.ReplicationServer.writeNRTPoint:input_type -> luceneserver.IndexName
	79, // 78: luceneserver.ReplicationServer.getCurrentSearcherVersion:input_type -> luceneserver.IndexName
	81, // 79: luceneserver.ReplicationServer.getConnectedNodes:input_type -> luceneserver.GetNodesRequest
	8,  // 80: luceneserver.LuceneServer.createIndex:output_type -> luceneserver.CreateIndexResponse
	10, // 81: luceneserver.LuceneServer.liveSettings:output_type -> luceneserver.LiveSettingsResponse
	13, // 82: luceneserver.LuceneServer.registerFields:output_type -> luceneserver.FieldDefResponse
	13, // 83: luceneserver.LuceneServer.updateFields:output_type -> luceneserver.FieldDefResponse
	15, // 84: luceneserver.LuceneServer.settings:output_type -> luceneserver.SettingsResponse
	17, // 85: luceneserver.LuceneServer.startIndex:output_type -> luceneserver.StartIndexResponse
	33, // 86: luceneserver.LuceneServer.stopIndex:output_type -> luceneserver.DummyResponse
	20, // 87: luceneserver.LuceneServer.addDocuments:output_type -> luceneserver.AddDocumentResponse
	22, // 88: luceneserver.LuceneServer.refresh:output_type -> luceneserver.RefreshResponse
	24, // 89: luceneserver.LuceneServer.commit:output_type -> luceneserver.CommitResponse
	26, // 90: luceneserver.LuceneServer.stats:output_type -> luceneserver.StatsResponse
	96, // 91: luceneserver.LuceneServer.search:output_type -> luceneserver.SearchResponse
	20, // 92: luceneserver.LuceneServer.delete:output_type -> luceneserver.AddDocumentResponse
	20, // 93: luceneserver.LuceneServer.deleteByQuery:output_type -> luceneserver.AddDocumentResponse
	30, // 94: luceneserver.LuceneServer.deleteAll:output_type -> luceneserver.DeleteAllDocumentsResponse
	32, // 95: luceneserver.LuceneServer.deleteIndex:output_type -> luceneserver.DeleteIndexResponse
	36, // 96: luceneserver.LuceneServer.buildSuggest:output_type -> luceneserver.BuildSuggestResponse
	38, // 97: luceneserver.LuceneServer.suggestLookup:output_type -> luceneserver.SuggestLookupResponse
	36, // 98: luceneserver.LuceneServer.updateSuggest:output_type -> luceneserver.BuildSuggestResponse
	48, // 99: luceneserver.LuceneServer.createSnapshot:output_type -> luceneserver.CreateSnapshotResponse
	51, // 100: luceneserver.LuceneServer.releaseSnapshot:output_type -> luceneserver.ReleaseSnapshotResponse
	53, // 101: luceneserver.LuceneServer.getAllSnapshotIndexGen:output_type -> luceneserver.GetAllSnapshotGenResponse
	55, // 102: luceneserver.LuceneServer.backupIndex:output_type -> luceneserver.BackupIndexResponse
	57, // 103: luceneserver.LuceneServer.deleteIndexBackup:output_type -> luceneserver.DeleteIndexBackupResponse
	63, // 104: luceneserver.LuceneServer.state:output_type -> luceneserver.StateResponse
	75, // 105: luceneserver.LuceneServer.status:output_type -> luceneserver.HealthCheckResponse
	75, // 106: luceneserver.LuceneServer.ready:output_type -> luceneserver.HealthCheckResponse
	97, // 107: luceneserver.LuceneServer.metrics:output_type -> google.api.HttpBody
	59, // 108: luceneserver.LuceneServer.indices:output_type -> luceneserver.IndicesResponse
	86, // 109: luceneserver.LuceneServer.forceMerge:output_type -> luceneserver.ForceMergeResponse
	65, // 110: luceneserver.ReplicationServer.addReplicas:output_type -> luceneserver.AddReplicaResponse
	66, // 111: luceneserver.ReplicationServer.recvCopyState:output_type -> luceneserver.CopyState
	77, // 112: luceneserver.ReplicationServer.sendRawFile:output_type -> luceneserver.TransferStatus
	73, // 113: luceneserver.ReplicationServer.recvRawFile:output_type -> luceneserver.RawFileChunk
	77, // 114: luceneserver.ReplicationServer.copyFiles:output_type -> luceneserver.TransferStatus
	77, // 115: luceneserver.ReplicationServer.newNRTPoint:output_type -> luceneserver.TransferStatus
	80, // 116: luceneserver.ReplicationServer.writeNRTPoint:output_type -> luceneserver.SearcherVersion
	80, // 117: luceneserver.ReplicationServer.getCurrentSearcherVersion:output_type -> luceneserver.SearcherVersion
	82, // 118: luceneserver.ReplicationServer.getConnectedNodes:output_type -> luceneserver.GetNodesResponse
