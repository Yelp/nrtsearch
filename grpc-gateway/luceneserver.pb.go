...
var file_yelp_nrtsearch_luceneserver_proto_rawDesc = []byte{
	...
	0x5f, 0x53, 0x55, 0x42, 0x4d, 0x49, 0x54, 0x54, 0x45, 0x44, 0x10, 0x01, 0x2a, 0x99, 0x01, 0x0a,
	...
	0x43, 0x55, 0x53, 0x54, 0x4f, 0x4d, 0x10, 0x0b, 0x2a, 0x64, 0x0a, 0x0c, 0x49, 0x6e, 0x64, 0x65,
	...
	0x32, 0x91, 0x17, 0x0a, 0x0c, 0x4c, 0x75, 0x63, 0x65, 0x6e, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65,
	...
	0x68, 0x6f, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0x6f, 0x0a, 0x0b, 0x62, 0x61, 0x63, 0x6b, 0x75, 0x70,
	...
	0x6e, 0x64, 0x65, 0x78, 0x3a, 0x01, 0x2a, 0x12, 0x6f, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65,
	...
	0x0a, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x50, 0x0a, 0x07, 0x6d,
	...
	0x76, 0x31, 0x2f, 0x69, 0x6e, 0x64, 0x69, 0x63, 0x65, 0x73, 0x12, 0x68, 0x0a, 0x0a, 0x66, 0x6f,
	...
	0x72, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x17, 0x82, 0xd3, 0xe4,
	0x93, 0x02, 0x11, 0x22, 0x0f, 0x2f, 0x76, 0x31, 0x2f, 0x66, 0x6f, 0x72, 0x63, 0x65, 0x5f, 0x6d,
	0x65, 0x72, 0x67, 0x65, 0x32, 0xd1, 0x05, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61,
...
var file_yelp_nrtsearch_luceneserver_proto_depIdxs = []int32{
	...
	86, // 9: luceneserver.Field.similarityParams:type_name -> google.protobuf.Struct
	11, // 10: luceneserver.FieldDefRequest.field:type_name -> luceneserver.Field
	87, // 11: luceneserver.SettingsRequest.indexSort:type_name -> luceneserver.SortFields
	4,  // 12: luceneserver.StartIndexRequest.mode:type_name -> luceneserver.Mode
	57, // 13: luceneserver.StartIndexRequest.restore:type_name -> luceneserver.RestoreIndex
	83, // 14: luceneserver.AddDocumentRequest.fields:type_name -> luceneserver.AddDocumentRequest.FieldsEntry
	...
	56, // 28: luceneserver.IndicesResponse.indicesResponse:type_name -> luceneserver.IndexStatsResponse
	26, // 29: luceneserver.IndexStatsResponse.statsResponse:type_name -> luceneserver.StatsResponse
	63, // 30: luceneserver.CopyState.filesMetadata:type_name -> luceneserver.FilesMetadata
	64, // 31: luceneserver.FilesMetadata.fileMetadata:type_name -> luceneserver.FileMetadata
	63, // 32: luceneserver.CopyFiles.filesMetadata:type_name -> luceneserver.FilesMetadata
	68, // 33: luceneserver.FilesInfo.fileInfo:type_name -> luceneserver.FileInfo
	...
	78, // 36: luceneserver.GetNodesResponse.nodes:type_name -> luceneserver.NodeInfo
	88, // 37: luceneserver.DeleteByQueryRequest.query:type_name -> luceneserver.Query
	...
	82, // 40: luceneserver.AddDocumentRequest.FieldsEntry.value:type_name -> luceneserver.AddDocumentRequest.MultiValuedField
	...
	89, // 52: luceneserver.LuceneServer.search:input_type -> luceneserver.SearchRequest
	18, // 53: luceneserver.LuceneServer.delete:input_type -> luceneserver.AddDocumentRequest
	79, // 54: luceneserver.LuceneServer.deleteByQuery:input_type -> luceneserver.DeleteByQueryRequest
	...
	52, // 62: luceneserver.LuceneServer.backupIndex:input_type -> luceneserver.BackupIndexRequest
	58, // 63: luceneserver.LuceneServer.state:input_type -> luceneserver.StateRequest
	70, // 64: luceneserver.LuceneServer.status:input_type -> luceneserver.HealthCheckRequest
	90, // 65: luceneserver.LuceneServer.metrics:input_type -> google.protobuf.Empty
	54, // 66: luceneserver.LuceneServer.indices:input_type -> luceneserver.IndicesRequest
	80, // 67: luceneserver.LuceneServer.forceMerge:input_type -> luceneserver.ForceMergeRequest
	60, // 68: luceneserver.ReplicationServer.addReplicas:input_type -> luceneserver.AddReplicaRequest
	66, // 69: luceneserver.ReplicationServer.recvCopyState:input_type -> luceneserver.CopyStateRequest
	69, // 70: luceneserver.ReplicationServer.sendRawFile:input_type -> luceneserver.RawFileChunk
	68, // 71: luceneserver.ReplicationServer.recvRawFile:input_type -> luceneserver.FileInfo
	65, // 72: luceneserver.ReplicationServer.copyFiles:input_type -> luceneserver.CopyFiles
	73, // 73: luceneserver.ReplicationServer.newNRTPoint:input_type -> luceneserver.NewNRTPoint
	74, // 74: luceneserver.ReplicationServer.writeNRTPoint:input_type -> luceneserver.IndexName
	74, // 75: luceneserver.ReplicationServer.getCurrentSearcherVersion:input_type -> luceneserver.IndexName
	76, // 76: luceneserver.ReplicationServer.getConnectedNodes:input_type -> luceneserver.GetNodesRequest
	...
	53, // 98: luceneserver.LuceneServer.backupIndex:output_type -> luceneserver.BackupIndexResponse
	59, // 99: luceneserver.LuceneServer.state:output_type -> luceneserver.StateResponse
	71, // 100: luceneserver.LuceneServer.status:output_type -> luceneserver.HealthCheckResponse
	92, // 101: luceneserver.LuceneServer.metrics:output_type -> google.api.HttpBody
	55, // 102: luceneserver.LuceneServer.indices:output_type -> luceneserver.IndicesResponse
	81, // 103: luceneserver.LuceneServer.forceMerge:output_type -> luceneserver.ForceMergeResponse
	61, // 104: luceneserver.ReplicationServer.addReplicas:output_type -> luceneserver.AddReplicaResponse
	62, // 105: luceneserver.ReplicationServer.recvCopyState:output_type -> luceneserver.CopyState
	72, // 106: luceneserver.ReplicationServer.sendRawFile:output_type -> luceneserver.TransferStatus
	69, // 107: luceneserver.ReplicationServer.recvRawFile:output_type -> luceneserver.RawFileChunk
	72, // 108: luceneserver.ReplicationServer.copyFiles:output_type -> luceneserver.TransferStatus
	72, // 109: luceneserver.ReplicationServer.newNRTPoint:output_type -> luceneserver.TransferStatus
	75, // 110: luceneserver.ReplicationServer.writeNRTPoint:output_type -> luceneserver.SearcherVersion
	75, // 111: luceneserver.ReplicationServer.getCurrentSearcherVersion:output_type -> luceneserver.SearcherVersion
	77, // 112: luceneserver.ReplicationServer.getConnectedNodes:output_type -> luceneserver.GetNodesResponse
