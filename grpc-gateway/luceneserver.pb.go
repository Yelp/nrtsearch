...
var file_yelp_nrtsearch_luceneserver_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x2a, 0x8d, 0x01, 0x0a, 0x09, 0x46, 0x69, 0x65, 0x6c, 0x64,
	...
	0x52, 0x4e, 0x41, 0x4c, 0x10, 0x0a, 0x2a, 0x64, 0x0a, 0x0c, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x4f,
	...
	0x02, 0x12, 0x0b, 0x0a, 0x07, 0x4f, 0x6e, 0x67, 0x6f, 0x69, 0x6e, 0x67, 0x10, 0x03, 0x32, 0xfd,
	0x14, 0x0a, 0x0c, 0x4c, 0x75, 0x63, 0x65, 0x6e, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12,
	...
	0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0x56, 0x0a, 0x05, 0x73, 0x74,
	...
	0x1b, 0x2e, 0x6c, 0x75, 0x63, 0x65, 0x6e, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x53,
	0x74, 0x61, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x14, 0x82, 0xd3,
	0xe4, 0x93, 0x02, 0x0e, 0x22, 0x09, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x73, 0x3a,
	0x01, 0x2a, 0x12, 0x5a, 0x0a, 0x06, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x12, 0x1b, 0x2e, 0x6c,
	...
	0x65, 0x3a, 0x01, 0x2a, 0x12, 0x79, 0x0a, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x41, 0x6c,
	...
	0x78, 0x3a, 0x01, 0x2a, 0x12, 0x56, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x1a, 0x2e,
	...
	0x2f, 0x76, 0x31, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x3a, 0x01, 0x2a, 0x12, 0x61, 0x0a, 0x06,
...
var file_yelp_nrtsearch_luceneserver_proto_msgTypes = make([]protoimpl.MessageInfo, 73)
var file_yelp_nrtsearch_luceneserver_proto_goTypes = []interface{}{
	...
	(*AddDocumentRequest_MultiValuedField)(nil), // 77: luceneserver.AddDocumentRequest.MultiValuedField
	nil,                       // 78: luceneserver.AddDocumentRequest.FieldsEntry
	(*Analyzer)(nil),          // 79: luceneserver.Analyzer
	(*SortFields)(nil),        // 80: luceneserver.SortFields
	(*SearchRequest)(nil),     // 81: luceneserver.SearchRequest
	(*empty.Empty)(nil),       // 82: google.protobuf.Empty
	(*SearchResponse)(nil),    // 83: luceneserver.SearchResponse
...
var file_yelp_nrtsearch_luceneserver_proto_depIdxs = []int32{
	...
	79, // 2: luceneserver.Field.analyzer:type_name -> luceneserver.Analyzer
	79, // 3: luceneserver.Field.indexAnalyzer:type_name -> luceneserver.Analyzer
	79, // 4: luceneserver.Field.searchAnalyzer:type_name -> luceneserver.Analyzer
	...
	80, // 8: luceneserver.SettingsRequest.indexSort:type_name -> luceneserver.SortFields
	...
	78, // 11: luceneserver.AddDocumentRequest.fields:type_name -> luceneserver.AddDocumentRequest.FieldsEntry
	...
	77, // 34: luceneserver.AddDocumentRequest.FieldsEntry.value:type_name -> luceneserver.AddDocumentRequest.MultiValuedField
	6,  // 35: luceneserver.LuceneServer.createIndex:input_type -> luceneserver.CreateIndexRequest
	8,  // 36: luceneserver.LuceneServer.liveSettings:input_type -> luceneserver.LiveSettingsRequest
	11, // 37: luceneserver.LuceneServer.registerFields:input_type -> luceneserver.FieldDefRequest
	11, // 38: luceneserver.LuceneServer.updateFields:input_type -> luceneserver.FieldDefRequest
	13, // 39: luceneserver.LuceneServer.settings:input_type -> luceneserver.SettingsRequest
	15, // 40: luceneserver.LuceneServer.startIndex:input_type -> luceneserver.StartIndexRequest
	32, // 41: luceneserver.LuceneServer.stopIndex:input_type -> luceneserver.StopIndexRequest
	17, // 42: luceneserver.LuceneServer.addDocuments:input_type -> luceneserver.AddDocumentRequest
	19, // 43: luceneserver.LuceneServer.refresh:input_type -> luceneserver.RefreshRequest
	21, // 44: luceneserver.LuceneServer.commit:input_type -> luceneserver.CommitRequest
	23, // 45: luceneserver.LuceneServer.stats:input_type -> luceneserver.StatsRequest
	81, // 46: luceneserver.LuceneServer.search:input_type -> luceneserver.SearchRequest
	17, // 47: luceneserver.LuceneServer.delete:input_type -> luceneserver.AddDocumentRequest
	27, // 48: luceneserver.LuceneServer.deleteAll:input_type -> luceneserver.DeleteAllDocumentsRequest
	29, // 49: luceneserver.LuceneServer.deleteIndex:input_type -> luceneserver.DeleteIndexRequest
	33, // 50: luceneserver.LuceneServer.buildSuggest:input_type -> luceneserver.BuildSuggestRequest
	35, // 51: luceneserver.LuceneServer.suggestLookup:input_type -> luceneserver.SuggestLookupRequest
	33, // 52: luceneserver.LuceneServer.updateSuggest:input_type -> luceneserver.BuildSuggestRequest
	45, // 53: luceneserver.LuceneServer.createSnapshot:input_type -> luceneserver.CreateSnapshotRequest
	48, // 54: luceneserver.LuceneServer.releaseSnapshot:input_type -> luceneserver.ReleaseSnapshotRequest
	50, // 55: luceneserver.LuceneServer.backupIndex:input_type -> luceneserver.BackupIndexRequest
	56, // 56: luceneserver.LuceneServer.state:input_type -> luceneserver.StateRequest
	68, // 57: luceneserver.LuceneServer.status:input_type -> luceneserver.HealthCheckRequest
	82, // 58: luceneserver.LuceneServer.metrics:input_type -> google.protobuf.Empty
	52, // 59: luceneserver.LuceneServer.indices:input_type -> luceneserver.IndicesRequest
	58, // 60: luceneserver.ReplicationServer.addReplicas:input_type -> luceneserver.AddReplicaRequest
	64, // 61: luceneserver.ReplicationServer.recvCopyState:input_type -> luceneserver.CopyStateRequest
	67, // 62: luceneserver.ReplicationServer.sendRawFile:input_type -> luceneserver.RawFileChunk
	66, // 63: luceneserver.ReplicationServer.recvRawFile:input_type -> luceneserver.FileInfo
	63, // 64: luceneserver.ReplicationServer.copyFiles:input_type -> luceneserver.CopyFiles
	71, // 65: luceneserver.ReplicationServer.newNRTPoint:input_type -> luceneserver.NewNRTPoint
	72, // 66: luceneserver.ReplicationServer.writeNRTPoint:input_type -> luceneserver.IndexName
	72, // 67: luceneserver.ReplicationServer.getCurrentSearcherVersion:input_type -> luceneserver.IndexName
	74, // 68: luceneserver.ReplicationServer.getConnectedNodes:input_type -> luceneserver.GetNodesRequest
	7,  // 69: luceneserver.LuceneServer.createIndex:output_type -> luceneserver.CreateIndexResponse
	9,  // 70: luceneserver.LuceneServer.liveSettings:output_type -> luceneserver.LiveSettingsResponse
	12, // 71: luceneserver.LuceneServer.registerFields:output_type -> luceneserver.FieldDefResponse
	12, // 72: luceneserver.LuceneServer.updateFields:output_type -> luceneserver.FieldDefResponse
	14, // 73: luceneserver.LuceneServer.settings:output_type -> luceneserver.SettingsResponse
	16, // 74: luceneserver.LuceneServer.startIndex:output_type -> luceneserver.StartIndexResponse
	31, // 75: luceneserver.LuceneServer.stopIndex:output_type -> luceneserver.DummyResponse
	18, // 76: luceneserver.LuceneServer.addDocuments:output_type -> luceneserver.AddDocumentResponse
	20, // 77: luceneserver.LuceneServer.refresh:output_type -> luceneserver.RefreshResponse
	22, // 78: luceneserver.LuceneServer.commit:output_type -> luceneserver.CommitResponse
	24, // 79: luceneserver.LuceneServer.stats:output_type -> luceneserver.StatsResponse
	83, // 80: luceneserver.LuceneServer.search:output_type -> luceneserver.SearchResponse
	18, // 81: luceneserver.LuceneServer.delete:output_type -> luceneserver.AddDocumentResponse
	28, // 82: luceneserver.LuceneServer.deleteAll:output_type -> luceneserver.DeleteAllDocumentsResponse
	30, // 83: luceneserver.LuceneServer.deleteIndex:output_type -> luceneserver.DeleteIndexResponse
	34, // 84: luceneserver.LuceneServer.buildSuggest:output_type -> luceneserver.BuildSuggestResponse
	36, // 85: luceneserver.LuceneServer.suggestLookup:output_type -> luceneserver.SuggestLookupResponse
	34, // 86: luceneserver.LuceneServer.updateSuggest:output_type -> luceneserver.BuildSuggestResponse
	46, // 87: luceneserver.LuceneServer.createSnapshot:output_type -> luceneserver.CreateSnapshotResponse
	49, // 88: luceneserver.LuceneServer.releaseSnapshot:output_type -> luceneserver.ReleaseSnapshotResponse
	51, // 89: luceneserver.LuceneServer.backupIndex:output_type -> luceneserver.BackupIndexResponse
	57, // 90: luceneserver.LuceneServer.state:output_type -> luceneserver.StateResponse
	69, // 91: luceneserver.LuceneServer.status:output_type -> luceneserver.HealthCheckResponse
	84, // 92: luceneserver.LuceneServer.metrics:output_type -> google.api.HttpBody
	53, // 93: luceneserver.LuceneServer.indices:output_type -> luceneserver.IndicesResponse
	59, // 94: luceneserver.ReplicationServer.addReplicas:output_type -> luceneserver.AddReplicaResponse
	60, // 95: luceneserver.ReplicationServer.recvCopyState:output_type -> luceneserver.CopyState
	70, // 96: luceneserver.ReplicationServer.sendRawFile:output_type -> luceneserver.TransferStatus
	67, // 97: luceneserver.ReplicationServer.recvRawFile:output_type -> luceneserver.RawFileChunk
	70, // 98: luceneserver.ReplicationServer.copyFiles:output_type -> luceneserver.TransferStatus
	70, // 99: luceneserver.ReplicationServer.newNRTPoint:output_type -> luceneserver.TransferStatus
	73, // 100: luceneserver.ReplicationServer.writeNRTPoint:output_type -> luceneserver.SearcherVersion
	73, // 101: luceneserver.ReplicationServer.getCurrentSearcherVersion:output_type -> luceneserver.SearcherVersion
	75, // 102: luceneserver.ReplicationServer.getConnectedNodes:output_type -> luceneserver.GetNodesResponse
