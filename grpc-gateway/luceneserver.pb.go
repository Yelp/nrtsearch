...
var file_yelp_nrtsearch_luceneserver_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x2a, 0x8d, 0x01, 0x0a, 0x09,
	...
	0x08, 0x49, 0x4e, 0x54, 0x45, 0x52, 0x4e, 0x41, 0x4c, 0x10, 0x0a, 0x2a, 0x64, 0x0a, 0x0c, 0x49,
	...
	0x67, 0x10, 0x03, 0x32, 0xa8, 0x14, 0x0a, 0x0c, 0x4c, 0x75, 0x63, 0x65, 0x6e, 0x65, 0x53, 0x65,
	...
	0x56, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x73, 0x12, 0x1a, 0x2e, 0x6c, 0x75, 0x63, 0x65, 0x6e,
	...
	0x65, 0x22, 0x14, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0e, 0x22, 0x09, 0x2f, 0x76, 0x31, 0x2f, 0x73,
	0x74, 0x61, 0x74, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x5a, 0x0a, 0x06, 0x73, 0x65, 0x61, 0x72, 0x63,
	...
	0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x3a, 0x01, 0x2a, 0x12, 0x79, 0x0a, 0x09, 0x64, 0x65, 0x6c,
	...
	0x65, 0x78, 0x3a, 0x01, 0x2a, 0x12, 0x64, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12,
	...
	0x31, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x73, 0x0a, 0x0c, 0x62,
	...
	0x73, 0x65, 0x5f, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0x6f,
...
var file_yelp_nrtsearch_luceneserver_proto_msgTypes = make([]protoimpl.MessageInfo, 71)
var file_yelp_nrtsearch_luceneserver_proto_goTypes = []interface{}{
	...
	(*AddReplicaRequest)(nil),                   // 56: luceneserver.AddReplicaRequest
	(*AddReplicaResponse)(nil),                  // 57: luceneserver.AddReplicaResponse
	(*CopyState)(nil),                           // 58: luceneserver.CopyState
	(*FilesMetadata)(nil),                       // 59: luceneserver.FilesMetadata
	(*FileMetadata)(nil),                        // 60: luceneserver.FileMetadata
	(*CopyFiles)(nil),                           // 61: luceneserver.CopyFiles
	(*CopyStateRequest)(nil),                    // 62: luceneserver.CopyStateRequest
	(*FilesInfo)(nil),                           // 63: luceneserver.FilesInfo
	(*FileInfo)(nil),                            // 64: luceneserver.FileInfo
	(*RawFileChunk)(nil),                        // 65: luceneserver.RawFileChunk
	(*HealthCheckRequest)(nil),                  // 66: luceneserver.HealthCheckRequest
	(*HealthCheckResponse)(nil),                 // 67: luceneserver.HealthCheckResponse
	...
	(*SortFields)(nil),        // 78: luceneserver.SortFields
	(*SearchRequest)(nil),     // 79: luceneserver.SearchRequest
	(*empty.Empty)(nil),       // 80: google.protobuf.Empty
	(*SearchResponse)(nil),    // 81: luceneserver.SearchResponse
...
var file_yelp_nrtsearch_luceneserver_proto_depIdxs = []int32{
	...
	77, // 2: luceneserver.Field.analyzer:type_name -> luceneserver.Analyzer
	77, // 3: luceneserver.Field.indexAnalyzer:type_name -> luceneserver.Analyzer
	77, // 4: luceneserver.Field.searchAnalyzer:type_name -> luceneserver.Analyzer
	...
	78, // 8: luceneserver.SettingsRequest.indexSort:type_name -> luceneserver.SortFields
	...
	76, // 11: luceneserver.AddDocumentRequest.fields:type_name -> luceneserver.AddDocumentRequest.FieldsEntry
	...
	59, // 27: luceneserver.CopyState.filesMetadata:type_name -> luceneserver.FilesMetadata
	60, // 28: luceneserver.FilesMetadata.fileMetadata:type_name -> luceneserver.FileMetadata
	59, // 29: luceneserver.CopyFiles.filesMetadata:type_name -> luceneserver.FilesMetadata
	64, // 30: luceneserver.FilesInfo.fileInfo:type_name -> luceneserver.FileInfo
	...
	74, // 33: luceneserver.GetNodesResponse.nodes:type_name -> luceneserver.NodeInfo
	75, // 34: luceneserver.AddDocumentRequest.FieldsEntry.value:type_name -> luceneserver.AddDocumentRequest.MultiValuedField
	...
	79, // 46: luceneserver.LuceneServer.search:input_type -> luceneserver.SearchRequest
	...
	66, // 50: luceneserver.LuceneServer.status:input_type -> luceneserver.HealthCheckRequest
	33, // 51: luceneserver.LuceneServer.buildSuggest:input_type -> luceneserver.BuildSuggestRequest
	35, // 52: luceneserver.LuceneServer.suggestLookup:input_type -> luceneserver.SuggestLookupRequest
	33, // 53: luceneserver.LuceneServer.updateSuggest:input_type -> luceneserver.BuildSuggestRequest
	45, // 54: luceneserver.LuceneServer.createSnapshot:input_type -> luceneserver.CreateSnapshotRequest
	48, // 55: luceneserver.LuceneServer.releaseSnapshot:input_type -> luceneserver.ReleaseSnapshotRequest
	50, // 56: luceneserver.LuceneServer.backupIndex:input_type -> luceneserver.BackupIndexRequest
	80, // 57: luceneserver.LuceneServer.metrics:input_type -> google.protobuf.Empty
	52, // 58: luceneserver.LuceneServer.indices:input_type -> luceneserver.IndicesRequest
	56, // 59: luceneserver.ReplicationServer.addReplicas:input_type -> luceneserver.AddReplicaRequest
	62, // 60: luceneserver.ReplicationServer.recvCopyState:input_type -> luceneserver.CopyStateRequest
	65, // 61: luceneserver.ReplicationServer.sendRawFile:input_type -> luceneserver.RawFileChunk
	64, // 62: luceneserver.ReplicationServer.recvRawFile:input_type -> luceneserver.FileInfo
	61, // 63: luceneserver.ReplicationServer.copyFiles:input_type -> luceneserver.CopyFiles
	69, // 64: luceneserver.ReplicationServer.newNRTPoint:input_type -> luceneserver.NewNRTPoint
	70, // 65: luceneserver.ReplicationServer.writeNRTPoint:input_type -> luceneserver.IndexName
	70, // 66: luceneserver.ReplicationServer.getCurrentSearcherVersion:input_type -> luceneserver.IndexName
	72, // 67: luceneserver.ReplicationServer.getConnectedNodes:input_type -> luceneserver.GetNodesRequest
	7,  // 68: luceneserver.LuceneServer.createIndex:output_type -> luceneserver.CreateIndexResponse
	9,  // 69: luceneserver.LuceneServer.liveSettings:output_type -> luceneserver.LiveSettingsResponse
	12, // 70: luceneserver.LuceneServer.registerFields:output_type -> luceneserver.FieldDefResponse
	12, // 71: luceneserver.LuceneServer.updateFields:output_type -> luceneserver.FieldDefResponse
	14, // 72: luceneserver.LuceneServer.settings:output_type -> luceneserver.SettingsResponse
	16, // 73: luceneserver.LuceneServer.startIndex:output_type -> luceneserver.StartIndexResponse
	31, // 74: luceneserver.LuceneServer.stopIndex:output_type -> luceneserver.DummyResponse
	18, // 75: luceneserver.LuceneServer.addDocuments:output_type -> luceneserver.AddDocumentResponse
	20, // 76: luceneserver.LuceneServer.refresh:output_type -> luceneserver.RefreshResponse
	22, // 77: luceneserver.LuceneServer.commit:output_type -> luceneserver.CommitResponse
	24, // 78: luceneserver.LuceneServer.stats:output_type -> luceneserver.StatsResponse
	81, // 79: luceneserver.LuceneServer.search:output_type -> luceneserver.SearchResponse
	18, // 80: luceneserver.LuceneServer.delete:output_type -> luceneserver.AddDocumentResponse
	28, // 81: luceneserver.LuceneServer.deleteAll:output_type -> luceneserver.DeleteAllDocumentsResponse
	30, // 82: luceneserver.LuceneServer.deleteIndex:output_type -> luceneserver.DeleteIndexResponse
	67, // 83: luceneserver.LuceneServer.status:output_type -> luceneserver.HealthCheckResponse
	...
	82, // 90: luceneserver.LuceneServer.metrics:output_type -> google.api.HttpBody
	53, // 91: luceneserver.LuceneServer.indices:output_type -> luceneserver.IndicesResponse
	57, // 92: luceneserver.ReplicationServer.addReplicas:output_type -> luceneserver.AddReplicaResponse
	58, // 93: luceneserver.ReplicationServer.recvCopyState:output_type -> luceneserver.CopyState
	68, // 94: luceneserver.ReplicationServer.sendRawFile:output_type -> luceneserver.TransferStatus
	65, // 95: luceneserver.ReplicationServer.recvRawFile:output_type -> luceneserver.RawFileChunk
	68, // 96: luceneserver.ReplicationServer.copyFiles:output_type -> luceneserver.TransferStatus
	68, // 97: luceneserver.ReplicationServer.newNRTPoint:output_type -> luceneserver.TransferStatus
	71, // 98: luceneserver.ReplicationServer.writeNRTPoint:output_type -> luceneserver.SearcherVersion
	71, // 99: luceneserver.ReplicationServer.getCurrentSearcherVersion:output_type -> luceneserver.SearcherVersion
	73, // 100: luceneserver.ReplicationServer.getConnectedNodes:output_type -> luceneserver.GetNodesResponse
