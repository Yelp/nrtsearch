...
var file_yelp_nrtsearch_luceneserver_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x54, 0x0a,
	...
	0x61, 0x6d, 0x65, 0x22, 0x2c, 0x0a, 0x0c, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x4e, 0x61, 0x6d, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x4e, 0x61, 0x6d,
	...
	0x66, 0x6f, 0x52, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x5e, 0x0a, 0x08,
	...
	0x09, 0x52, 0x09, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x28, 0x0a, 0x0c,
	...
	0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x2a, 0x0a, 0x12, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68,
	...
	0x01, 0x2a, 0xbb, 0x01, 0x0a, 0x09, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x4e, 0x10, 0x0d, 0x12, 0x0a, 0x0a, 0x06, 0x4f, 0x42, 0x4a, 0x45, 0x43, 0x54, 0x10, 0x0e, 0x2a,
	...
	0x67, 0x6f, 0x69, 0x6e, 0x67, 0x10, 0x03, 0x32, 0x9a, 0x1c, 0x0a, 0x0c, 0x4c, 0x75, 0x63, 0x65,
	...
	0x76, 0x65, 0x5f, 0x73, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x6f,
...
var file_yelp_nrtsearch_luceneserver_proto_goTypes = []interface{}{
	...
	(*any.Any)(nil),               // 90: google.protobuf.Any
	(*BuildSuggestResponse)(nil),  // 91: luceneserver.BuildSuggestResponse
	(*SuggestLookupResponse)(nil), // 92: luceneserver.SuggestLookupResponse
...
var file_yelp_nrtsearch_luceneserver_proto_depIdxs = []int32{
	...
	85, // 47: luceneserver.LuceneServer.searchV2:input_type -> luceneserver.SearchRequest
	19, // 48: luceneserver.LuceneServer.delete:input_type -> luceneserver.AddDocumentRequest
	73, // 49: luceneserver.LuceneServer.deleteByQuery:input_type -> luceneserver.DeleteByQueryRequest
	...
	86, // 52: luceneserver.LuceneServer.buildSuggest:input_type -> luceneserver.BuildSuggestRequest
	87, // 53: luceneserver.LuceneServer.suggestLookup:input_type -> luceneserver.SuggestLookupRequest
	86, // 54: luceneserver.LuceneServer.updateSuggest:input_type -> luceneserver.BuildSuggestRequest
	...
	45, // 59: luceneserver.LuceneServer.deleteIndexBackup:input_type -> luceneserver.DeleteIndexBackupRequest
	51, // 60: luceneserver.LuceneServer.state:input_type -> luceneserver.StateRequest
	63, // 61: luceneserver.LuceneServer.status:input_type -> luceneserver.HealthCheckRequest
	65, // 62: luceneserver.LuceneServer.ready:input_type -> luceneserver.ReadyCheckRequest
	88, // 63: luceneserver.LuceneServer.metrics:input_type -> google.protobuf.Empty
	47, // 64: luceneserver.LuceneServer.indices:input_type -> luceneserver.IndicesRequest
	74, // 65: luceneserver.LuceneServer.forceMerge:input_type -> luceneserver.ForceMergeRequest
	76, // 66: luceneserver.LuceneServer.forceMergeDeletes:input_type -> luceneserver.ForceMergeDeletesRequest
	53, // 67: luceneserver.ReplicationServer.addReplicas:input_type -> luceneserver.AddReplicaRequest
	59, // 68: luceneserver.ReplicationServer.recvCopyState:input_type -> luceneserver.CopyStateRequest
	62, // 69: luceneserver.ReplicationServer.sendRawFile:input_type -> luceneserver.RawFileChunk
	61, // 70: luceneserver.ReplicationServer.recvRawFile:input_type -> luceneserver.FileInfo
	58, // 71: luceneserver.ReplicationServer.copyFiles:input_type -> luceneserver.CopyFiles
	67, // 72: luceneserver.ReplicationServer.newNRTPoint:input_type -> luceneserver.NewNRTPoint
	68, // 73: luceneserver.ReplicationServer.writeNRTPoint:input_type -> luceneserver.IndexName
	68, // 74: luceneserver.ReplicationServer.getCurrentSearcherVersion:input_type -> luceneserver.IndexName
	70, // 75: luceneserver.ReplicationServer.getConnectedNodes:input_type -> luceneserver.GetNodesRequest
	9,  // 76: luceneserver.LuceneServer.createIndex:output_type -> luceneserver.CreateIndexResponse
	11, // 77: luceneserver.LuceneServer.liveSettings:output_type -> luceneserver.LiveSettingsResponse
	14, // 78: luceneserver.LuceneServer.registerFields:output_type -> luceneserver.FieldDefResponse
	14, // 79: luceneserver.LuceneServer.updateFields:output_type -> luceneserver.FieldDefResponse
	16, // 80: luceneserver.LuceneServer.settings:output_type -> luceneserver.SettingsResponse
	18, // 81: luceneserver.LuceneServer.startIndex:output_type -> luceneserver.StartIndexResponse
	34, // 82: luceneserver.LuceneServer.stopIndex:output_type -> luceneserver.DummyResponse
	21, // 83: luceneserver.LuceneServer.addDocuments:output_type -> luceneserver.AddDocumentResponse
	23, // 84: luceneserver.LuceneServer.refresh:output_type -> luceneserver.RefreshResponse
	25, // 85: luceneserver.LuceneServer.commit:output_type -> luceneserver.CommitResponse
	27, // 86: luceneserver.LuceneServer.stats:output_type -> luceneserver.StatsResponse
	89, // 87: luceneserver.LuceneServer.search:output_type -> luceneserver.SearchResponse
	90, // 88: luceneserver.LuceneServer.searchV2:output_type -> google.protobuf.Any
	21, // 89: luceneserver.LuceneServer.delete:output_type -> luceneserver.AddDocumentResponse
	21, // 90: luceneserver.LuceneServer.deleteByQuery:output_type -> luceneserver.AddDocumentResponse
	31, // 91: luceneserver.LuceneServer.deleteAll:output_type -> luceneserver.DeleteAllDocumentsResponse
	33, // 92: luceneserver.LuceneServer.deleteIndex:output_type -> luceneserver.DeleteIndexResponse
	91, // 93: luceneserver.LuceneServer.buildSuggest:output_type -> luceneserver.BuildSuggestResponse
	92, // 94: luceneserver.LuceneServer.suggestLookup:output_type -> luceneserver.SuggestLookupResponse
	91, // 95: luceneserver.LuceneServer.updateSuggest:output_type -> luceneserver.BuildSuggestResponse
	37, // 96: luceneserver.LuceneServer.createSnapshot:output_type -> luceneserver.CreateSnapshotResponse
	40, // 97: luceneserver.LuceneServer.releaseSnapshot:output_type -> luceneserver.ReleaseSnapshotResponse
	42, // 98: luceneserver.LuceneServer.getAllSnapshotIndexGen:output_type -> luceneserver.GetAllSnapshotGenResponse
	44, // 99: luceneserver.LuceneServer.backupIndex:output_type -> luceneserver.BackupIndexResponse
	46, // 100: luceneserver.LuceneServer.deleteIndexBackup:output_type -> luceneserver.DeleteIndexBackupResponse
	52, // 101: luceneserver.LuceneServer.state:output_type -> luceneserver.StateResponse
	64, // 102: luceneserver.LuceneServer.status:output_type -> luceneserver.HealthCheckResponse
	64, // 103: luceneserver.LuceneServer.ready:output_type -> luceneserver.HealthCheckResponse
	93, // 104: luceneserver.LuceneServer.metrics:output_type -> google.api.HttpBody
	48, // 105: luceneserver.LuceneServer.indices:output_type -> luceneserver.IndicesResponse
	75, // 106: luceneserver.LuceneServer.forceMerge:output_type -> luceneserver.ForceMergeResponse
	77, // 107: luceneserver.LuceneServer.forceMergeDeletes:output_type -> luceneserver.ForceMergeDeletesResponse
	54, // 108: luceneserver.ReplicationServer.addReplicas:output_type -> luceneserver.AddReplicaResponse
	55, // 109: luceneserver.ReplicationServer.recvCopyState:output_type -> luceneserver.CopyState
	66, // 110: luceneserver.ReplicationServer.sendRawFile:output_type -> luceneserver.TransferStatus
	62, // 111: luceneserver.ReplicationServer.recvRawFile:output_type -> luceneserver.RawFileChunk
	66, // 112: luceneserver.ReplicationServer.copyFiles:output_type -> luceneserver.TransferStatus
	66, // 113: luceneserver.ReplicationServer.newNRTPoint:output_type -> luceneserver.TransferStatus
	69, // 114: luceneserver.ReplicationServer.writeNRTPoint:output_type -> luceneserver.SearcherVersion
	69, // 115: luceneserver.ReplicationServer.getCurrentSearcherVersion:output_type -> luceneserver.SearcherVersion
	71, // 116: luceneserver.ReplicationServer.getConnectedNodes:output_type -> luceneserver.GetNodesResponse
