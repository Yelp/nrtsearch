...
var file_yelp_nrtsearch_luceneserver_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x2a, 0x8d,
	...
	0x12, 0x0c, 0x0a, 0x08, 0x49, 0x4e, 0x54, 0x45, 0x52, 0x4e, 0x41, 0x4c, 0x10, 0x0a, 0x2a, 0x64,
	...
	0x2a, 0x4d, 0x0a, 0x0a, 0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b,
	...
	0x59, 0x10, 0x02, 0x12, 0x0d, 0x0a, 0x09, 0x48, 0x49, 0x53, 0x54, 0x4f, 0x47, 0x52, 0x41, 0x4d,
	0x10, 0x03, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x54, 0x59, 0x50, 0x45, 0x44, 0x10, 0x04, 0x2a,
	...
	0x69, 0x6e, 0x67, 0x10, 0x03, 0x32, 0x84, 0x16, 0x0a, 0x0c, 0x4c, 0x75, 0x63, 0x65, 0x6e, 0x65,
	...
	0x2a, 0x12, 0x56, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x73, 0x12, 0x1a, 0x2e, 0x6c, 0x75, 0x63,
	...
	0x2f, 0x73, 0x74, 0x61, 0x74, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x5a, 0x0a, 0x06, 0x73, 0x65, 0x61,
	...
	0x01, 0x2a, 0x12, 0x6f, 0x0a, 0x0b, 0x62, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x49, 0x6e, 0x64, 0x65,
	...
	0x3a, 0x01, 0x2a, 0x12, 0x56, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x1a, 0x2e, 0x6c,
	...
	0x76, 0x31, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x3a, 0x01, 0x2a, 0x12, 0x61, 0x0a, 0x06, 0x73,
	...
	0x0a, 0x07, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x12, 0x1c, 0x2e, 0x6c, 0x75, 0x63, 0x65,
	0x6e, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x6c, 0x75, 0x63, 0x65, 0x6e, 0x65,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x52, 0x65,
	...
	0x0b, 0x2f, 0x76, 0x31, 0x2f, 0x69, 0x6e, 0x64, 0x69, 0x63, 0x65, 0x73, 0x32, 0xd1, 0x05, 0x0a,
...
var file_yelp_nrtsearch_luceneserver_proto_goTypes = []interface{}{
	...
	(*AddDocumentRequest_MultiValuedField)(nil), // 83: luceneserver.AddDocumentRequest.MultiValuedField
	nil,                    // 84: luceneserver.AddDocumentRequest.FieldsEntry
	(*Analyzer)(nil),       // 85: luceneserver.Analyzer
	(*SortFields)(nil),     // 86: luceneserver.SortFields
	(*Query)(nil),          // 87: luceneserver.Query
	(*SearchRequest)(nil),  // 88: luceneserver.SearchRequest
...
var file_yelp_nrtsearch_luceneserver_proto_depIdxs = []int32{
	...
	85, // 2: luceneserver.Field.analyzer:type_name -> luceneserver.Analyzer
	85, // 3: luceneserver.Field.indexAnalyzer:type_name -> luceneserver.Analyzer
	85, // 4: luceneserver.Field.searchAnalyzer:type_name -> luceneserver.Analyzer
	...
	86, // 8: luceneserver.SettingsRequest.indexSort:type_name -> luceneserver.SortFields
	...
	84, // 11: luceneserver.AddDocumentRequest.fields:type_name -> luceneserver.AddDocumentRequest.FieldsEntry
	...
	66, // 30: luceneserver.CopyState.filesMetadata:type_name -> luceneserver.FilesMetadata
	67, // 31: luceneserver.FilesMetadata.fileMetadata:type_name -> luceneserver.FileMetadata
	66, // 32: luceneserver.CopyFiles.filesMetadata:type_name -> luceneserver.FilesMetadata
	71, // 33: luceneserver.FilesInfo.fileInfo:type_name -> luceneserver.FileInfo
	...
	87, // 37: luceneserver.DeleteByQueryRequest.query:type_name -> luceneserver.Query
	83, // 38: luceneserver.AddDocumentRequest.FieldsEntry.value:type_name -> luceneserver.AddDocumentRequest.MultiValuedField
	7,  // 39: luceneserver.LuceneServer.createIndex:input_type -> luceneserver.CreateIndexRequest
	9,  // 40: luceneserver.LuceneServer.liveSettings:input_type -> luceneserver.LiveSettingsRequest
	12, // 41: luceneserver.LuceneServer.registerFields:input_type -> luceneserver.FieldDefRequest
	12, // 42: luceneserver.LuceneServer.updateFields:input_type -> luceneserver.FieldDefRequest
	14, // 43: luceneserver.LuceneServer.settings:input_type -> luceneserver.SettingsRequest
	16, // 44: luceneserver.LuceneServer.startIndex:input_type -> luceneserver.StartIndexRequest
	33, // 45: luceneserver.LuceneServer.stopIndex:input_type -> luceneserver.StopIndexRequest
	18, // 46: luceneserver.LuceneServer.addDocuments:input_type -> luceneserver.AddDocumentRequest
	20, // 47: luceneserver.LuceneServer.refresh:input_type -> luceneserver.RefreshRequest
	22, // 48: luceneserver.LuceneServer.commit:input_type -> luceneserver.CommitRequest
	24, // 49: luceneserver.LuceneServer.stats:input_type -> luceneserver.StatsRequest
	88, // 50: luceneserver.LuceneServer.search:input_type -> luceneserver.SearchRequest
	18, // 51: luceneserver.LuceneServer.delete:input_type -> luceneserver.AddDocumentRequest
	82, // 52: luceneserver.LuceneServer.deleteByQuery:input_type -> luceneserver.DeleteByQueryRequest
	28, // 53: luceneserver.LuceneServer.deleteAll:input_type -> luceneserver.DeleteAllDocumentsRequest
	30, // 54: luceneserver.LuceneServer.deleteIndex:input_type -> luceneserver.DeleteIndexRequest
	34, // 55: luceneserver.LuceneServer.buildSuggest:input_type -> luceneserver.BuildSuggestRequest
	36, // 56: luceneserver.LuceneServer.suggestLookup:input_type -> luceneserver.SuggestLookupRequest
	34, // 57: luceneserver.LuceneServer.updateSuggest:input_type -> luceneserver.BuildSuggestRequest
	46, // 58: luceneserver.LuceneServer.createSnapshot:input_type -> luceneserver.CreateSnapshotRequest
	49, // 59: luceneserver.LuceneServer.releaseSnapshot:input_type -> luceneserver.ReleaseSnapshotRequest
	51, // 60: luceneserver.LuceneServer.backupIndex:input_type -> luceneserver.BackupIndexRequest
	61, // 61: luceneserver.LuceneServer.state:input_type -> luceneserver.StateRequest
	73, // 62: luceneserver.LuceneServer.status:input_type -> luceneserver.HealthCheckRequest
	53, // 63: luceneserver.LuceneServer.metrics:input_type -> luceneserver.MetricsRequest
	57, // 64: luceneserver.LuceneServer.indices:input_type -> luceneserver.IndicesRequest
	63, // 65: luceneserver.ReplicationServer.addReplicas:input_type -> luceneserver.AddReplicaRequest
	69, // 66: luceneserver.ReplicationServer.recvCopyState:input_type -> luceneserver.CopyStateRequest
	72, // 67: luceneserver.ReplicationServer.sendRawFile:input_type -> luceneserver.RawFileChunk
	71, // 68: luceneserver.ReplicationServer.recvRawFile:input_type -> luceneserver.FileInfo
	68, // 69: luceneserver.ReplicationServer.copyFiles:input_type -> luceneserver.CopyFiles
	76, // 70: luceneserver.ReplicationServer.newNRTPoint:input_type -> luceneserver.NewNRTPoint
	77, // 71: luceneserver.ReplicationServer.writeNRTPoint:input_type -> luceneserver.IndexName
	77, // 72: luceneserver.ReplicationServer.getCurrentSearcherVersion:input_type -> luceneserver.IndexName
	79, // 73: luceneserver.ReplicationServer.getConnectedNodes:input_type -> luceneserver.GetNodesRequest
	8,  // 74: luceneserver.LuceneServer.createIndex:output_type -> luceneserver.CreateIndexResponse
	10, // 75: luceneserver.LuceneServer.liveSettings:output_type -> luceneserver.LiveSettingsResponse
	13, // 76: luceneserver.LuceneServer.registerFields:output_type -> luceneserver.FieldDefResponse
	13, // 77: luceneserver.LuceneServer.updateFields:output_type -> luceneserver.FieldDefResponse
	15, // 78: luceneserver.LuceneServer.settings:output_type -> luceneserver.SettingsResponse
	17, // 79: luceneserver.LuceneServer.startIndex:output_type -> luceneserver.StartIndexResponse
	32, // 80: luceneserver.LuceneServer.stopIndex:output_type -> luceneserver.DummyResponse
	19, // 81: luceneserver.LuceneServer.addDocuments:output_type -> luceneserver.AddDocumentResponse
	21, // 82: luceneserver.LuceneServer.refresh:output_type -> luceneserver.RefreshResponse
	23, // 83: luceneserver.LuceneServer.commit:output_type -> luceneserver.CommitResponse
	25, // 84: luceneserver.LuceneServer.stats:output_type -> luceneserver.StatsResponse
	89, // 85: luceneserver.LuceneServer.search:output_type -> luceneserver.SearchResponse
	19, // 86: luceneserver.LuceneServer.delete:output_type -> luceneserver.AddDocumentResponse
	19, // 87: luceneserver.LuceneServer.deleteByQuery:output_type -> luceneserver.AddDocumentResponse
	29, // 88: luceneserver.LuceneServer.deleteAll:output_type -> luceneserver.DeleteAllDocumentsResponse
	31, // 89: luceneserver.LuceneServer.deleteIndex:output_type -> luceneserver.DeleteIndexResponse
	35, // 90: luceneserver.LuceneServer.buildSuggest:output_type -> luceneserver.BuildSuggestResponse
	37, // 91: luceneserver.LuceneServer.suggestLookup:output_type -> luceneserver.SuggestLookupResponse
	35, // 92: luceneserver.LuceneServer.updateSuggest:output_type -> luceneserver.BuildSuggestResponse
	47, // 93: luceneserver.LuceneServer.createSnapshot:output_type -> luceneserver.CreateSnapshotResponse
	50, // 94: luceneserver.LuceneServer.releaseSnapshot:output_type -> luceneserver.ReleaseSnapshotResponse
	52, // 95: luceneserver.LuceneServer.backupIndex:output_type -> luceneserver.BackupIndexResponse
	62, // 96: luceneserver.LuceneServer.state:output_type -> luceneserver.StateResponse
	74, // 97: luceneserver.LuceneServer.status:output_type -> luceneserver.HealthCheckResponse
	54, // 98: luceneserver.LuceneServer.metrics:output_type -> luceneserver.MetricsResponse
	58, // 99: luceneserver.LuceneServer.indices:output_type -> luceneserver.IndicesResponse
	64, // 100: luceneserver.ReplicationServer.addReplicas:output_type -> luceneserver.AddReplicaResponse
	65, // 101: luceneserver.ReplicationServer.recvCopyState:output_type -> luceneserver.CopyState
	75, // 102: luceneserver.ReplicationServer.sendRawFile:output_type -> luceneserver.TransferStatus
	72, // 103: luceneserver.ReplicationServer.recvRawFile:output_type -> luceneserver.RawFileChunk
	75, // 104: luceneserver.ReplicationServer.copyFiles:output_type -> luceneserver.TransferStatus
	75, // 105: luceneserver.ReplicationServer.newNRTPoint:output_type -> luceneserver.TransferStatus
	78, // 106: luceneserver.ReplicationServer.writeNRTPoint:output_type -> luceneserver.SearcherVersion
	78, // 107: luceneserver.ReplicationServer.getCurrentSearcherVersion:output_type -> luceneserver.SearcherVersion
	80, // 108: luceneserver.ReplicationServer.getConnectedNodes:output_type -> luceneserver.GetNodesResponse
