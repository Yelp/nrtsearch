...
var file_yelp_nrtsearch_luceneserver_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x68, 0x2a, 0x8d, 0x01, 0x0a, 0x09, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x54, 0x79, 0x70,
	...
	0x4c, 0x10, 0x0a, 0x2a, 0x64, 0x0a, 0x0c, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x4f, 0x70, 0x74, 0x69,
	...
	0x49, 0x43, 0x41, 0x10, 0x02, 0x2a, 0x4d, 0x0a, 0x0a, 0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x54,
	0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x43, 0x4f, 0x55, 0x4e, 0x54, 0x45, 0x52, 0x10, 0x00,
	0x12, 0x09, 0x0a, 0x05, 0x47, 0x41, 0x55, 0x47, 0x45, 0x10, 0x01, 0x12, 0x0b, 0x0a, 0x07, 0x53,
	0x55, 0x4d, 0x4d, 0x41, 0x52, 0x59, 0x10, 0x02, 0x12, 0x0d, 0x0a, 0x09, 0x48, 0x49, 0x53, 0x54,
	0x4f, 0x47, 0x52, 0x41, 0x4d, 0x10, 0x03, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x54, 0x59, 0x50,
	0x45, 0x44, 0x10, 0x04, 0x2a, 0x44, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72,
	...
	0x07, 0x4f, 0x6e, 0x67, 0x6f, 0x69, 0x6e, 0x67, 0x10, 0x03, 0x32, 0xb7, 0x14, 0x0a, 0x0c, 0x4c,
	...
	0x6d, 0x69, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0x56, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x73, 0x12,
	...
	0x22, 0x09, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x5a,
	...
	0x65, 0x74, 0x65, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x3a, 0x01, 0x2a, 0x12, 0x64, 0x0a, 0x06,
	...
	0x65, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x15, 0x82, 0xd3, 0xe4,
	0x93, 0x02, 0x0f, 0x22, 0x0a, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x3a,
	...
	0x64, 0x65, 0x78, 0x3a, 0x01, 0x2a, 0x12, 0x5f, 0x0a, 0x07, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63,
	...
	0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x17,
	...
	0x69, 0x63, 0x65, 0x73, 0x32, 0xfb, 0x04, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61,
...
var file_yelp_nrtsearch_luceneserver_proto_goTypes = []interface{}{
	...
	(*SearchResponse)(nil), // 82: luceneserver.SearchResponse
}
var file_yelp_nrtsearch_luceneserver_proto_depIdxs = []int32{
	...
	77, // 36: luceneserver.AddDocumentRequest.FieldsEntry.value:type_name -> luceneserver.AddDocumentRequest.MultiValuedField
	7,  // 37: luceneserver.LuceneServer.createIndex:input_type -> luceneserver.CreateIndexRequest
	9,  // 38: luceneserver.LuceneServer.liveSettings:input_type -> luceneserver.LiveSettingsRequest
	12, // 39: luceneserver.LuceneServer.registerFields:input_type -> luceneserver.FieldDefRequest
	12, // 40: luceneserver.LuceneServer.updateFields:input_type -> luceneserver.FieldDefRequest
	14, // 41: luceneserver.LuceneServer.settings:input_type -> luceneserver.SettingsRequest
	16, // 42: luceneserver.LuceneServer.startIndex:input_type -> luceneserver.StartIndexRequest
	33, // 43: luceneserver.LuceneServer.stopIndex:input_type -> luceneserver.StopIndexRequest
	18, // 44: luceneserver.LuceneServer.addDocuments:input_type -> luceneserver.AddDocumentRequest
	20, // 45: luceneserver.LuceneServer.refresh:input_type -> luceneserver.RefreshRequest
	22, // 46: luceneserver.LuceneServer.commit:input_type -> luceneserver.CommitRequest
	24, // 47: luceneserver.LuceneServer.stats:input_type -> luceneserver.StatsRequest
	81, // 48: luceneserver.LuceneServer.search:input_type -> luceneserver.SearchRequest
	18, // 49: luceneserver.LuceneServer.delete:input_type -> luceneserver.AddDocumentRequest
	28, // 50: luceneserver.LuceneServer.deleteAll:input_type -> luceneserver.DeleteAllDocumentsRequest
	30, // 51: luceneserver.LuceneServer.deleteIndex:input_type -> luceneserver.DeleteIndexRequest
	71, // 52: luceneserver.LuceneServer.status:input_type -> luceneserver.HealthCheckRequest
	...
	53, // 59: luceneserver.LuceneServer.metrics:input_type -> luceneserver.MetricsRequest
	57, // 60: luceneserver.LuceneServer.indices:input_type -> luceneserver.IndicesRequest
	61, // 61: luceneserver.ReplicationServer.addReplicas:input_type -> luceneserver.AddReplicaRequest
	67, // 62: luceneserver.ReplicationServer.recvCopyState:input_type -> luceneserver.CopyStateRequest
	70, // 63: luceneserver.ReplicationServer.sendRawFile:input_type -> luceneserver.RawFileChunk
	69, // 64: luceneserver.ReplicationServer.recvRawFile:input_type -> luceneserver.FileInfo
	66, // 65: luceneserver.ReplicationServer.copyFiles:input_type -> luceneserver.CopyFiles
	74, // 66: luceneserver.ReplicationServer.newNRTPoint:input_type -> luceneserver.NewNRTPoint
	75, // 67: luceneserver.ReplicationServer.writeNRTPoint:input_type -> luceneserver.IndexName
	75, // 68: luceneserver.ReplicationServer.getCurrentSearcherVersion:input_type -> luceneserver.IndexName
	8,  // 69: luceneserver.LuceneServer.createIndex:output_type -> luceneserver.CreateIndexResponse
	10, // 70: luceneserver.LuceneServer.liveSettings:output_type -> luceneserver.LiveSettingsResponse
	13, // 71: luceneserver.LuceneServer.registerFields:output_type -> luceneserver.FieldDefResponse
	13, // 72: luceneserver.LuceneServer.updateFields:output_type -> luceneserver.FieldDefResponse
	15, // 73: luceneserver.LuceneServer.settings:output_type -> luceneserver.SettingsResponse
	17, // 74: luceneserver.LuceneServer.startIndex:output_type -> luceneserver.StartIndexResponse
	32, // 75: luceneserver.LuceneServer.stopIndex:output_type -> luceneserver.DummyResponse
	19, // 76: luceneserver.LuceneServer.addDocuments:output_type -> luceneserver.AddDocumentResponse
	21, // 77: luceneserver.LuceneServer.refresh:output_type -> luceneserver.RefreshResponse
	23, // 78: luceneserver.LuceneServer.commit:output_type -> luceneserver.CommitResponse
	25, // 79: luceneserver.LuceneServer.stats:output_type -> luceneserver.StatsResponse
	82, // 80: luceneserver.LuceneServer.search:output_type -> luceneserver.SearchResponse
	19, // 81: luceneserver.LuceneServer.delete:output_type -> luceneserver.AddDocumentResponse
	29, // 82: luceneserver.LuceneServer.deleteAll:output_type -> luceneserver.DeleteAllDocumentsResponse
	31, // 83: luceneserver.LuceneServer.deleteIndex:output_type -> luceneserver.DeleteIndexResponse
	72, // 84: luceneserver.LuceneServer.status:output_type -> luceneserver.HealthCheckResponse
	35, // 85: luceneserver.LuceneServer.buildSuggest:output_type -> luceneserver.BuildSuggestResponse
	37, // 86: luceneserver.LuceneServer.suggestLookup:output_type -> luceneserver.SuggestLookupResponse
	35, // 87: luceneserver.LuceneServer.updateSuggest:output_type -> luceneserver.BuildSuggestResponse
	47, // 88: luceneserver.LuceneServer.createSnapshot:output_type -> luceneserver.CreateSnapshotResponse
	50, // 89: luceneserver.LuceneServer.releaseSnapshot:output_type -> luceneserver.ReleaseSnapshotResponse
	52, // 90: luceneserver.LuceneServer.backupIndex:output_type -> luceneserver.BackupIndexResponse
	54, // 91: luceneserver.LuceneServer.metrics:output_type -> luceneserver.MetricsResponse
	58, // 92: luceneserver.LuceneServer.indices:output_type -> luceneserver.IndicesResponse
	62, // 93: luceneserver.ReplicationServer.addReplicas:output_type -> luceneserver.AddReplicaResponse
	63, // 94: luceneserver.ReplicationServer.recvCopyState:output_type -> luceneserver.CopyState
	73, // 95: luceneserver.ReplicationServer.sendRawFile:output_type -> luceneserver.TransferStatus
	70, // 96: luceneserver.ReplicationServer.recvRawFile:output_type -> luceneserver.RawFileChunk
	73, // 97: luceneserver.ReplicationServer.copyFiles:output_type -> luceneserver.TransferStatus
	73, // 98: luceneserver.ReplicationServer.newNRTPoint:output_type -> luceneserver.TransferStatus
	76, // 99: luceneserver.ReplicationServer.writeNRTPoint:output_type -> luceneserver.SearcherVersion
	76, // 100: luceneserver.ReplicationServer.getCurrentSearcherVersion:output_type -> luceneserver.SearcherVersion
