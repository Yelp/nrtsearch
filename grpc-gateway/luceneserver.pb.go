...
func (ForceMergeResponse_Status) EnumDescriptor() ([]byte, []int) {
	return file_yelp_nrtsearch_luceneserver_proto_rawDescGZIP(), []int{73, 0}
}
...
func (ForceMergeDeletesResponse_Status) EnumDescriptor() ([]byte, []int) {
	return file_yelp_nrtsearch_luceneserver_proto_rawDescGZIP(), []int{75, 0}
}
...
type Field struct {
	...
	SimilarityParams     *_struct.Struct `protobuf:"bytes,25,opt,name=similarityParams,proto3" json:"similarityParams,omitempty"`         // Parameters for similarity implementation.
...
func (x *Field) GetSimilarityParams() *_struct.Struct {
	if x != nil {
...
type IndexSettings struct {
	...
	NrtCachingDirectoryMaxMergeSizeMB *wrappers.DoubleValue `protobuf:"bytes,1,opt,name=nrtCachingDirectoryMaxMergeSizeMB,proto3" json:"nrtCachingDirectoryMaxMergeSizeMB,omitempty"`
	// Largest overall size for all files cached in NRTCachingDirectory, default: 60.0MB
	NrtCachingDirectoryMaxSizeMB *wrappers.DoubleValue `protobuf:"bytes,2,opt,name=nrtCachingDirectoryMaxSizeMB,proto3" json:"nrtCachingDirectoryMaxSizeMB,omitempty"`
	// How many merge threads to allow at once
	ConcurrentMergeSchedulerMaxThreadCount *wrappers.Int32Value `protobuf:"bytes,3,opt,name=concurrentMergeSchedulerMaxThreadCount,proto3" json:"concurrentMergeSchedulerMaxThreadCount,omitempty"`
	// Maximum backlog of pending merges before indexing threads are stalled
	ConcurrentMergeSchedulerMaxMergeCount *wrappers.Int32Value `protobuf:"bytes,4,opt,name=concurrentMergeSchedulerMaxMergeCount,proto3" json:"concurrentMergeSchedulerMaxMergeCount,omitempty"`
	...
	IndexMergeSchedulerAutoThrottle *wrappers.BoolValue `protobuf:"bytes,6,opt,name=indexMergeSchedulerAutoThrottle,proto3" json:"indexMergeSchedulerAutoThrottle,omitempty"`
	// Base Directory implementation to use (NRTCachingDirectory will wrap this) either one of the core implementations (FSDirectory, MMapDirectory, NIOFSDirectory, SimpleFSDirectory, RAMDirectory (for temporary indices!) or a fully qualified path to a Directory implementation that has a public constructor taking a single File argument default: FSDirectory
	Directory *wrappers.StringValue `protobuf:"bytes,7,opt,name=directory,proto3" json:"directory,omitempty"`
}
...
func (x *IndexSettings) GetNrtCachingDirectoryMaxMergeSizeMB() *wrappers.DoubleValue {
	if x != nil {
		return x.NrtCachingDirectoryMaxMergeSizeMB
	}
	return nil
...
func (x *IndexSettings) GetNrtCachingDirectoryMaxSizeMB() *wrappers.DoubleValue {
	if x != nil {
		return x.NrtCachingDirectoryMaxSizeMB
	}
	return nil
...
func (x *IndexSettings) GetConcurrentMergeSchedulerMaxThreadCount() *wrappers.Int32Value {
	if x != nil {
		return x.ConcurrentMergeSchedulerMaxThreadCount
	}
	return nil
...
func (x *IndexSettings) GetConcurrentMergeSchedulerMaxMergeCount() *wrappers.Int32Value {
	if x != nil {
		return x.ConcurrentMergeSchedulerMaxMergeCount
	}
	return nil
...
func (x *IndexSettings) GetIndexMergeSchedulerAutoThrottle() *wrappers.BoolValue {
	if x != nil {
		return x.IndexMergeSchedulerAutoThrottle
	}
	return nil
...
func (x *IndexSettings) GetDirectory() *wrappers.StringValue {
	if x != nil {
		return x.Directory
	}
	return nil
...
type IndexLiveSettings struct {
	...
	MaxRefreshSec *wrappers.DoubleValue `protobuf:"bytes,1,opt,name=maxRefreshSec,proto3" json:"maxRefreshSec,omitempty"`
	// Shortest time to wait before reopening IndexSearcher (i.e., when a search is waiting for a specific indexGen), default: 0.05
	MinRefreshSec *wrappers.DoubleValue `protobuf:"bytes,2,opt,name=minRefreshSec,proto3" json:"minRefreshSec,omitempty"`
	// Non-current searchers older than this are pruned, default: 60.0
	MaxSearcherAgeSec *wrappers.DoubleValue `protobuf:"bytes,3,opt,name=maxSearcherAgeSec,proto3" json:"maxSearcherAgeSec,omitempty"`
	// Size (in MB) of IndexWriter's RAM buffer, default: 16.0
	IndexRamBufferSizeMB *wrappers.DoubleValue `protobuf:"bytes,4,opt,name=indexRamBufferSizeMB,proto3" json:"indexRamBufferSizeMB,omitempty"`
	// Max number of documents to add at a time, default: 100
	AddDocumentsMaxBufferLen *wrappers.Int32Value `protobuf:"bytes,5,opt,name=addDocumentsMaxBufferLen,proto3" json:"addDocumentsMaxBufferLen,omitempty"`
	// Maximum number of documents allowed in a parallel search slice, default: 250,000
	SliceMaxDocs *wrappers.Int32Value `protobuf:"bytes,6,opt,name=sliceMaxDocs,proto3" json:"sliceMaxDocs,omitempty"`
	// Maximum number of segments allowed in a parallel search slice, default: 5
	SliceMaxSegments *wrappers.Int32Value `protobuf:"bytes,7,opt,name=sliceMaxSegments,proto3" json:"sliceMaxSegments,omitempty"`
	// Number of virtual shards to use for this index, default: 1
	VirtualShards *wrappers.Int32Value `protobuf:"bytes,8,opt,name=virtualShards,proto3" json:"virtualShards,omitempty"`
	// Maximum sized segment to produce during normal merging, default: 5GB
	MaxMergedSegmentMB *wrappers.Int32Value `protobuf:"bytes,9,opt,name=maxMergedSegmentMB,proto3" json:"maxMergedSegmentMB,omitempty"`
	// Number of segments per tier used by TieredMergePolicy, default: 10
	SegmentsPerTier *wrappers.Int32Value `protobuf:"bytes,10,opt,name=segmentsPerTier,proto3" json:"segmentsPerTier,omitempty"`
	// Timeout value to used when not specified in the search request, or 0 for no timeout, default: 0
	DefaultSearchTimeoutSec *wrappers.DoubleValue `protobuf:"bytes,11,opt,name=defaultSearchTimeoutSec,proto3" json:"defaultSearchTimeoutSec,omitempty"`
	// Timeout check every value to use when not specified in the search request, or 0 for none, default: 0
	DefaultSearchTimeoutCheckEvery *wrappers.Int32Value `protobuf:"bytes,12,opt,name=defaultSearchTimeoutCheckEvery,proto3" json:"defaultSearchTimeoutCheckEvery,omitempty"`
	// Terminate after value to use when not specified in the search request, or 0 for none, default: 0
	DefaultTerminateAfter *wrappers.Int32Value `protobuf:"bytes,13,opt,name=defaultTerminateAfter,proto3" json:"defaultTerminateAfter,omitempty"`
}
...
func (x *IndexLiveSettings) GetMaxRefreshSec() *wrappers.DoubleValue {
	if x != nil {
		return x.MaxRefreshSec
	}
	return nil
...
func (x *IndexLiveSettings) GetMinRefreshSec() *wrappers.DoubleValue {
	if x != nil {
		return x.MinRefreshSec
	}
	return nil
...
func (x *IndexLiveSettings) GetMaxSearcherAgeSec() *wrappers.DoubleValue {
	if x != nil {
		return x.MaxSearcherAgeSec
	}
	return nil
...
func (x *IndexLiveSettings) GetIndexRamBufferSizeMB() *wrappers.DoubleValue {
	if x != nil {
		return x.IndexRamBufferSizeMB
	}
	return nil
...
func (x *IndexLiveSettings) GetAddDocumentsMaxBufferLen() *wrappers.Int32Value {
	if x != nil {
		return x.AddDocumentsMaxBufferLen
	}
	return nil
...
func (x *IndexLiveSettings) GetSliceMaxDocs() *wrappers.Int32Value {
	if x != nil {
		return x.SliceMaxDocs
	}
	return nil
...
func (x *IndexLiveSettings) GetSliceMaxSegments() *wrappers.Int32Value {
	if x != nil {
		return x.SliceMaxSegments
	}
	return nil
...
func (x *IndexLiveSettings) GetVirtualShards() *wrappers.Int32Value {
	if x != nil {
		return x.VirtualShards
	}
	return nil
...
func (x *IndexLiveSettings) GetMaxMergedSegmentMB() *wrappers.Int32Value {
	if x != nil {
		return x.MaxMergedSegmentMB
	}
	return nil
...
func (x *IndexLiveSettings) GetSegmentsPerTier() *wrappers.Int32Value {
	if x != nil {
		return x.SegmentsPerTier
	}
	return nil
...
func (x *IndexLiveSettings) GetDefaultSearchTimeoutSec() *wrappers.DoubleValue {
	if x != nil {
		return x.DefaultSearchTimeoutSec
	}
	return nil
...
func (x *IndexLiveSettings) GetDefaultSearchTimeoutCheckEvery() *wrappers.Int32Value {
	if x != nil {
		return x.DefaultSearchTimeoutCheckEvery
	}
	return nil
...
func (x *IndexLiveSettings) GetDefaultTerminateAfter() *wrappers.Int32Value {
	if x != nil {
		return x.DefaultTerminateAfter
	}
	return nil
...
func (*AddDocumentRequest_MultiValuedField) Descriptor() ([]byte, []int) {
	return file_yelp_nrtsearch_luceneserver_proto_rawDescGZIP(), []int{15, 0}
}
...
var file_yelp_nrtsearch_luceneserver_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x32, 0x0a, 0x12, 0x43, 0x72,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x31,
	0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x52, 0x65, 0x73,
	...
	0x65, 0x22, 0xa5, 0x05, 0x0a, 0x13, 0x4c, 0x69, 0x76, 0x65, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x7a, 0x0a,
	0x15, 0x4c, 0x69, 0x76, 0x65, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x56, 0x32, 0x52,
	...
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x43, 0x0a, 0x0c, 0x6c, 0x69, 0x76, 0x65, 0x53, 0x65, 0x74, 0x74,
	0x69, 0x6e, 0x67, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0
	0x02, 0x1c, 0x22, 0x17, 0x2f, 0x76, 0x31, 0x2f, 0x66, 0x6f, 0x72, 0x63, 0x65, 0x5f, 0x6d, 0x65,
	0x72, 0x67, 0x65, 0x5f, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x66,
	0x0a, 0x06, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x12, 0x1b, 0x2e, 0x6c, 0x75, 0x63, 0x65, 0x6e,
	...
	,
	...
	0x52, 0x61, 0x77, 0x46, 0x69, 0x6c, 0x65, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x22, 0x00, 0x30, 0x01,
	0x12, 0x49, 0x0a, 0x0d, 0x72, 0x65, 0x63, 0x76, 0x52, 0x61, 0x77, 0x46, 0x69, 0x6c, 0x65, 0x56,
	0x32, 0x12, 0x16, 0x2e, 0x6c, 0x75, 0x63, 0x65, 0x6e, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72,
	...
	,
	...
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x00, 0x12, 0x55, 0x0a, 0x19, 0x67, 0x65, 0x74, 0x43,
	0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x65, 0x72, 0x56, 0x65,
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x17, 0x2e, 0x6c, 0x75, 0x63, 0x65, 0x6e, 0x65, 0x73, 0x65,
	...
	,
...
var file_yelp_nrtsearch_luceneserver_proto_msgTypes = make([]protoimpl.MessageInfo, 89)
var file_yelp_nrtsearch_luceneserver_proto_goTypes = []interface{}{
	...
	(*StartIndexResponse)(nil),                  // 22: luceneserver.StartIndexResponse
	(*AddDocumentRequest)(nil),                  // 23: luceneserver.AddDocumentRequest
	(*FacetHierarchyPath)(nil),                  // 24: luceneserver.FacetHierarchyPath
	(*AddDocumentResponse)(nil),                 // 25: luceneserver.AddDocumentResponse
	(*RefreshRequest)(nil),                      // 26: luceneserver.RefreshRequest
	(*RefreshResponse)(nil),                     // 27: luceneserver.RefreshResponse
	(*CommitRequest)(nil),                       // 28: luceneserver.CommitRequest
	(*CommitResponse)(nil),                      // 29: luceneserver.CommitResponse
	(*StatsRequest)(nil),                        // 30: luceneserver.StatsRequest
	(*StatsResponse)(nil),                       // 31: luceneserver.StatsResponse
	(*Taxonomy)(nil),                            // 32: luceneserver.Taxonomy
	(*Searcher)(nil),                            // 33: luceneserver.Searcher
	(*DeleteAllDocumentsRequest)(nil),           // 34: luceneserver.DeleteAllDocumentsRequest
	(*DeleteAllDocumentsResponse)(nil),          // 35: luceneserver.DeleteAllDocumentsResponse
	(*DeleteIndexRequest)(nil),                  // 36: luceneserver.DeleteIndexRequest
	(*DeleteIndexResponse)(nil),                 // 37: luceneserver.DeleteIndexResponse
	(*DummyResponse)(nil),                       // 38: luceneserver.DummyResponse
	(*StopIndexRequest)(nil),                    // 39: luceneserver.StopIndexRequest
	(*CreateSnapshotRequest)(nil),               // 40: luceneserver.CreateSnapshotRequest
	(*CreateSnapshotResponse)(nil),              // 41: luceneserver.CreateSnapshotResponse
	(*SnapshotId)(nil),                          // 42: luceneserver.SnapshotId
	(*ReleaseSnapshotRequest)(nil),              // 43: luceneserver.ReleaseSnapshotRequest
	(*ReleaseSnapshotResponse)(nil),             // 44: luceneserver.ReleaseSnapshotResponse
	(*GetAllSnapshotGenRequest)(nil),            // 45: luceneserver.GetAllSnapshotGenRequest
	(*GetAllSnapshotGenResponse)(nil),           // 46: luceneserver.GetAllSnapshotGenResponse
	(*BackupIndexRequest)(nil),                  // 47: luceneserver.BackupIndexRequest
	(*BackupIndexResponse)(nil),                 // 48: luceneserver.BackupIndexResponse
	(*BackupWarmingQueriesRequest)(nil),         // 49: luceneserver.BackupWarmingQueriesRequest
	(*BackupWarmingQueriesResponse)(nil),        // 50: luceneserver.BackupWarmingQueriesResponse
	(*DeleteIndexBackupRequest)(nil),            // 51: luceneserver.DeleteIndexBackupRequest
	(*DeleteIndexBackupResponse)(nil),           // 52: luceneserver.DeleteIndexBackupResponse
	(*IndicesRequest)(nil),                      // 53: luceneserver.IndicesRequest
	(*IndicesResponse)(nil),                     // 54: luceneserver.IndicesResponse
	(*IndexStatsResponse)(nil),                  // 55: luceneserver.IndexStatsResponse
	(*RestoreIndex)(nil),                        // 56: luceneserver.RestoreIndex
	(*StateRequest)(nil),                        // 57: luceneserver.StateRequest
	(*StateResponse)(nil),                       // 58: luceneserver.StateResponse
	(*AddReplicaRequest)(nil),                   // 59: luceneserver.AddReplicaRequest
	(*AddReplicaResponse)(nil),                  // 60: luceneserver.AddReplicaResponse
	(*CopyState)(nil),                           // 61: luceneserver.CopyState
	(*FilesMetadata)(nil),                       // 62: luceneserver.FilesMetadata
	(*FileMetadata)(nil),                        // 63: luceneserver.FileMetadata
	(*CopyFiles)(nil),                           // 64: luceneserver.CopyFiles
	(*CopyStateRequest)(nil),                    // 65: luceneserver.CopyStateRequest
	(*FilesInfo)(nil),                           // 66: luceneserver.FilesInfo
	(*FileInfo)(nil),                            // 67: luceneserver.FileInfo
	(*RawFileChunk)(nil),                        // 68: luceneserver.RawFileChunk
	(*HealthCheckRequest)(nil),                  // 69: luceneserver.HealthCheckRequest
	(*HealthCheckResponse)(nil),                 // 70: luceneserver.HealthCheckResponse
	(*ReadyCheckRequest)(nil),                   // 71: luceneserver.ReadyCheckRequest
	(*TransferStatus)(nil),                      // 72: luceneserver.TransferStatus
	(*NewNRTPoint)(nil),                         // 73: luceneserver.NewNRTPoint
	(*IndexName)(nil),                           // 74: luceneserver.IndexName
	(*SearcherVersion)(nil),                     // 75: luceneserver.SearcherVersion
	(*GetNodesRequest)(nil),                     // 76: luceneserver.GetNodesRequest
	(*GetNodesResponse)(nil),                    // 77: luceneserver.GetNodesResponse
	(*NodeInfo)(nil),                            // 78: luceneserver.NodeInfo
	(*DeleteByQueryRequest)(nil),                // 79: luceneserver.DeleteByQueryRequest
	(*ForceMergeRequest)(nil),                   // 80: luceneserver.ForceMergeRequest
	(*ForceMergeResponse)(nil),                  // 81: luceneserver.ForceMergeResponse
	(*ForceMergeDeletesRequest)(nil),            // 82: luceneserver.ForceMergeDeletesRequest
	(*ForceMergeDeletesResponse)(nil),           // 83: luceneserver.ForceMergeDeletesResponse
	(*IndexSettings)(nil),                       // 84: luceneserver.IndexSettings
	(*IndexLiveSettings)(nil),                   // 85: luceneserver.IndexLiveSettings
	(*IndexStateInfo)(nil),                      // 86: luceneserver.IndexStateInfo
	(*IndexGlobalState)(nil),                    // 87: luceneserver.IndexGlobalState
	(*GlobalStateInfo)(nil),                     // 88: luceneserver.GlobalStateInfo
	(*CustomRequest)(nil),                       // 89: luceneserver.CustomRequest
	(*CustomResponse)(nil),                      // 90: luceneserver.CustomResponse
	(*AddDocumentRequest_MultiValuedField)(nil), // 91: luceneserver.AddDocumentRequest.MultiValuedField
	nil,                           // 92: luceneserver.AddDocumentRequest.FieldsEntry
	nil,                           // 93: luceneserver.IndexStateInfo.FieldsEntry
	nil,                           // 94: luceneserver.GlobalStateInfo.IndicesEntry
	nil,                           // 95: luceneserver.CustomRequest.ParamsEntry
	nil,                           // 96: luceneserver.CustomResponse.ResponseEntry
	(*Script)(nil),                // 97: luceneserver.Script
	(*Analyzer)(nil),              // 98: luceneserver.Analyzer
	(*_struct.Struct)(nil),        // 99: google.protobuf.Struct
	(*SortFields)(nil),            // 100: luceneserver.SortFields
	(*Query)(nil),                 // 101: luceneserver.Query
	(*wrappers.DoubleValue)(nil),  // 102: google.protobuf.DoubleValue
	(*wrappers.Int32Value)(nil),   // 103: google.protobuf.Int32Value
	(*wrappers.BoolValue)(nil),    // 104: google.protobuf.BoolValue
	(*wrappers.StringValue)(nil),  // 105: google.protobuf.StringValue
	(*SearchRequest)(nil),         // 106: luceneserver.SearchRequest
	(*BuildSuggestRequest)(nil),   // 107: luceneserver.BuildSuggestRequest
	(*SuggestLookupRequest)(nil),  // 108: luceneserver.SuggestLookupRequest
	(*empty.Empty)(nil),           // 109: google.protobuf.Empty
	(*SearchResponse)(nil),        // 110: luceneserver.SearchResponse
	(*any.Any)(nil),               // 111: google.protobuf.Any
	(*BuildSuggestResponse)(nil),  // 112: luceneserver.BuildSuggestResponse
	(*SuggestLookupResponse)(nil), // 113: luceneserver.SuggestLookupResponse
	(*httpbody.HttpBody)(nil),     // 114: google.api.HttpBody
}
var file_yelp_nrtsearch_luceneserver_proto_depIdxs = []int32{
	85,  // 0: luceneserver.LiveSettingsV2Request.liveSettings:type_name -> luceneserver.IndexLiveSettings
	85,  // 1: luceneserver.LiveSettingsV2Response.liveSettings:type_name -> luceneserver.IndexLiveSettings
	0,   // 2: luceneserver.Field.type:type_name -> luceneserver.FieldType
	1,   // 3: luceneserver.Field.indexOptions:type_name -> luceneserver.IndexOptions
	97,  // 4: luceneserver.Field.script:type_name -> luceneserver.Script
	98,  // 5: luceneserver.Field.analyzer:type_name -> luceneserver.Analyzer
	98,  // 6: luceneserver.Field.indexAnalyzer:type_name -> luceneserver.Analyzer
	98,  // 7: luceneserver.Field.searchAnalyzer:type_name -> luceneserver.Analyzer
	2,   // 8: luceneserver.Field.termVectors:type_name -> luceneserver.TermVectors
	3,   // 9: luceneserver.Field.facet:type_name -> luceneserver.FacetType
	99,  // 10: luceneserver.Field.additionalProperties:type_name -> google.protobuf.Struct
	99,  // 11: luceneserver.Field.similarityParams:type_name -> google.protobuf.Struct
	14,  // 12: luceneserver.Field.childFields:type_name -> luceneserver.Field
	14,  // 13: luceneserver.FieldDefRequest.field:type_name -> luceneserver.Field
	100, // 14: luceneserver.SettingsRequest.indexSort:type_name -> luceneserver.SortFields
	84,  // 15: luceneserver.SettingsV2Request.settings:type_name -> luceneserver.IndexSettings
	84,  // 16: luceneserver.SettingsV2Response.settings:type_name -> luceneserver.IndexSettings
	4,   // 17: luceneserver.StartIndexRequest.mode:type_name -> luceneserver.Mode
	56,  // 18: luceneserver.StartIndexRequest.restore:type_name -> luceneserver.RestoreIndex
	92,  // 19: luceneserver.AddDocumentRequest.fields:type_name -> luceneserver.AddDocumentRequest.FieldsEntry
	32,  // 20: luceneserver.StatsResponse.taxonomy:type_name -> luceneserver.Taxonomy
	33,  // 21: luceneserver.StatsResponse.searchers:type_name -> luceneserver.Searcher
	33,  // 22: luceneserver.StatsResponse.currentSearcher:type_name -> luceneserver.Searcher
	42,  // 23: luceneserver.CreateSnapshotResponse.snapshotId:type_name -> luceneserver.SnapshotId
	42,  // 24: luceneserver.ReleaseSnapshotRequest.snapshotId:type_name -> luceneserver.SnapshotId
	55,  // 25: luceneserver.IndicesResponse.indicesResponse:type_name -> luceneserver.IndexStatsResponse
	31,  // 26: luceneserver.IndexStatsResponse.statsResponse:type_name -> luceneserver.StatsResponse
	62,  // 27: luceneserver.CopyState.filesMetadata:type_name -> luceneserver.FilesMetadata
	63,  // 28: luceneserver.FilesMetadata.fileMetadata:type_name -> luceneserver.FileMetadata
	62,  // 29: luceneserver.CopyFiles.filesMetadata:type_name -> luceneserver.FilesMetadata
	67,  // 30: luceneserver.FilesInfo.fileInfo:type_name -> luceneserver.FileInfo
	5,   // 31: luceneserver.HealthCheckResponse.health:type_name -> luceneserver.TransferStatusCode
	5,   // 32: luceneserver.TransferStatus.Code:type_name -> luceneserver.TransferStatusCode
	78,  // 33: luceneserver.GetNodesResponse.nodes:type_name -> luceneserver.NodeInfo
	101, // 34: luceneserver.DeleteByQueryRequest.query:type_name -> luceneserver.Query
	6,   // 35: luceneserver.ForceMergeResponse.status:type_name -> luceneserver.ForceMergeResponse.Status
	7,   // 36: luceneserver.ForceMergeDeletesResponse.status:type_name -> luceneserver.ForceMergeDeletesResponse.Status
	102, // 37: luceneserver.IndexSettings.nrtCachingDirectoryMaxMergeSizeMB:type_name -> google.protobuf.DoubleValue
	102, // 38: luceneserver.IndexSettings.nrtCachingDirectoryMaxSizeMB:type_name -> google.protobuf.DoubleValue
	103, // 39: luceneserver.IndexSettings.concurrentMergeSchedulerMaxThreadCount:type_name -> google.protobuf.Int32Value
	103, // 40: luceneserver.IndexSettings.concurrentMergeSchedulerMaxMergeCount:type_name -> google.protobuf.Int32Value
	100, // 41: luceneserver.IndexSettings.indexSort:type_name -> luceneserver.SortFields
	104, // 42: luceneserver.IndexSettings.indexMergeSchedulerAutoThrottle:type_name -> google.protobuf.BoolValue
	105, // 43: luceneserver.IndexSettings.directory:type_name -> google.protobuf.StringValue
	102, // 44: luceneserver.IndexLiveSettings.maxRefreshSec:type_name -> google.protobuf.DoubleValue
	102, // 45: luceneserver.IndexLiveSettings.minRefreshSec:type_name -> google.protobuf.DoubleValue
	102, // 46: luceneserver.IndexLiveSettings.maxSearcherAgeSec:type_name -> google.protobuf.DoubleValue
	102, // 47: luceneserver.IndexLiveSettings.indexRamBufferSizeMB:type_name -> google.protobuf.DoubleValue
	103, // 48: luceneserver.IndexLiveSettings.addDocumentsMaxBufferLen:type_name -> google.protobuf.Int32Value
	103, // 49: luceneserver.IndexLiveSettings.sliceMaxDocs:type_name -> google.protobuf.Int32Value
	103, // 50: luceneserver.IndexLiveSettings.sliceMaxSegments:type_name -> google.protobuf.Int32Value
	103, // 51: luceneserver.IndexLiveSettings.virtualShards:type_name -> google.protobuf.Int32Value
	103, // 52: luceneserver.IndexLiveSettings.maxMergedSegmentMB:type_name -> google.protobuf.Int32Value
	103, // 53: luceneserver.IndexLiveSettings.segmentsPerTier:type_name -> google.protobuf.Int32Value
	102, // 54: luceneserver.IndexLiveSettings.defaultSearchTimeoutSec:type_name -> google.protobuf.DoubleValue
	103, // 55: luceneserver.IndexLiveSettings.defaultSearchTimeoutCheckEvery:type_name -> google.protobuf.Int32Value
	103, // 56: luceneserver.IndexLiveSettings.defaultTerminateAfter:type_name -> google.protobuf.Int32Value
	84,  // 57: luceneserver.IndexStateInfo.settings:type_name -> luceneserver.IndexSettings
	85,  // 58: luceneserver.IndexStateInfo.liveSettings:type_name -> luceneserver.IndexLiveSettings
	93,  // 59: luceneserver.IndexStateInfo.fields:type_name -> luceneserver.IndexStateInfo.FieldsEntry
	94,  // 60: luceneserver.GlobalStateInfo.indices:type_name -> luceneserver.GlobalStateInfo.IndicesEntry
	95,  // 61: luceneserver.CustomRequest.params:type_name -> luceneserver.CustomRequest.ParamsEntry
	96,  // 62: luceneserver.CustomResponse.response:type_name -> luceneserver.CustomResponse.ResponseEntry
	24,  // 63: luceneserver.AddDocumentRequest.MultiValuedField.faceHierarchyPaths:type_name -> luceneserver.FacetHierarchyPath
	91,  // 64: luceneserver.AddDocumentRequest.FieldsEntry.value:type_name -> luceneserver.AddDocumentRequest.MultiValuedField
	14,  // 65: luceneserver.IndexStateInfo.FieldsEntry.value:type_name -> luceneserver.Field
	87,  // 66: luceneserver.GlobalStateInfo.IndicesEntry.value:type_name -> luceneserver.IndexGlobalState
	8,   // 67: luceneserver.LuceneServer.createIndex:input_type -> luceneserver.CreateIndexRequest
	10,  // 68: luceneserver.LuceneServer.liveSettings:input_type -> luceneserver.LiveSettingsRequest
	12,  // 69: luceneserver.LuceneServer.liveSettingsV2:input_type -> luceneserver.LiveSettingsV2Request
	15,  // 70: luceneserver.LuceneServer.registerFields:input_type -> luceneserver.FieldDefRequest
	15,  // 71: luceneserver.LuceneServer.updateFields:input_type -> luceneserver.FieldDefRequest
	17,  // 72: luceneserver.LuceneServer.settings:input_type -> luceneserver.SettingsRequest
	19,  // 73: luceneserver.LuceneServer.settingsV2:input_type -> luceneserver.SettingsV2Request
	21,  // 74: luceneserver.LuceneServer.startIndex:input_type -> luceneserver.StartIndexRequest
	39,  // 75: luceneserver.LuceneServer.stopIndex:input_type -> luceneserver.StopIndexRequest
	23,  // 76: luceneserver.LuceneServer.addDocuments:input_type -> luceneserver.AddDocumentRequest
	26,  // 77: luceneserver.LuceneServer.refresh:input_type -> luceneserver.RefreshRequest
	28,  // 78: luceneserver.LuceneServer.commit:input_type -> luceneserver.CommitRequest
	30,  // 79: luceneserver.LuceneServer.stats:input_type -> luceneserver.StatsRequest
	106, // 80: luceneserver.LuceneServer.search:input_type -> luceneserver.SearchRequest
	106, // 81: luceneserver.LuceneServer.searchV2:input_type -> luceneserver.SearchRequest
	23,  // 82: luceneserver.LuceneServer.delete:input_type -> luceneserver.AddDocumentRequest
	79,  // 83: luceneserver.LuceneServer.deleteByQuery:input_type -> luceneserver.DeleteByQueryRequest
	34,  // 84: luceneserver.LuceneServer.deleteAll:input_type -> luceneserver.DeleteAllDocumentsRequest
	36,  // 85: luceneserver.LuceneServer.deleteIndex:input_type -> luceneserver.DeleteIndexRequest
	107, // 86: luceneserver.LuceneServer.buildSuggest:input_type -> luceneserver.BuildSuggestRequest
	108, // 87: luceneserver.LuceneServer.suggestLookup:input_type -> luceneserver.SuggestLookupRequest
	107, // 88: luceneserver.LuceneServer.updateSuggest:input_type -> luceneserver.BuildSuggestRequest
	40,  // 89: luceneserver.LuceneServer.createSnapshot:input_type -> luceneserver.CreateSnapshotRequest
	43,  // 90: luceneserver.LuceneServer.releaseSnapshot:input_type -> luceneserver.ReleaseSnapshotRequest
	45,  // 91: luceneserver.LuceneServer.getAllSnapshotIndexGen:input_type -> luceneserver.GetAllSnapshotGenRequest
	47,  // 92: luceneserver.LuceneServer.backupIndex:input_type -> luceneserver.BackupIndexRequest
	51,  // 93: luceneserver.LuceneServer.deleteIndexBackup:input_type -> luceneserver.DeleteIndexBackupRequest
	49,  // 94: luceneserver.LuceneServer.backupWarmingQueries:input_type -> luceneserver.BackupWarmingQueriesRequest
	57,  // 95: luceneserver.LuceneServer.state:input_type -> luceneserver.StateRequest
	69,  // 96: luceneserver.LuceneServer.status:input_type -> luceneserver.HealthCheckRequest
	71,  // 97: luceneserver.LuceneServer.ready:input_type -> luceneserver.ReadyCheckRequest
	109, // 98: luceneserver.LuceneServer.metrics:input_type -> google.protobuf.Empty
	53,  // 99: luceneserver.LuceneServer.indices:input_type -> luceneserver.IndicesRequest
	80,  // 100: luceneserver.LuceneServer.forceMerge:input_type -> luceneserver.ForceMergeRequest
	82,  // 101: luceneserver.LuceneServer.forceMergeDeletes:input_type -> luceneserver.ForceMergeDeletesRequest
	89,  // 102: luceneserver.LuceneServer.custom:input_type -> luceneserver.CustomRequest
	59,  // 103: luceneserver.ReplicationServer.addReplicas:input_type -> luceneserver.AddReplicaRequest
	65,  // 104: luceneserver.ReplicationServer.recvCopyState:input_type -> luceneserver.CopyStateRequest
	68,  // 105: luceneserver.ReplicationServer.sendRawFile:input_type -> luceneserver.RawFileChunk
	67,  // 106: luceneserver.ReplicationServer.recvRawFile:input_type -> luceneserver.FileInfo
	67,  // 107: luceneserver.ReplicationServer.recvRawFileV2:input_type -> luceneserver.FileInfo
	64,  // 108: luceneserver.ReplicationServer.copyFiles:input_type -> luceneserver.CopyFiles
	73,  // 109: luceneserver.ReplicationServer.newNRTPoint:input_type -> luceneserver.NewNRTPoint
	74,  // 110: luceneserver.ReplicationServer.writeNRTPoint:input_type -> luceneserver.IndexName
	74,  // 111: luceneserver.ReplicationServer.getCurrentSearcherVersion:input_type -> luceneserver.IndexName
	76,  // 112: luceneserver.ReplicationServer.getConnectedNodes:input_type -> luceneserver.GetNodesRequest
	9,   // 113: luceneserver.LuceneServer.createIndex:output_type -> luceneserver.CreateIndexResponse
	11,  // 114: luceneserver.LuceneServer.liveSettings:output_type -> luceneserver.LiveSettingsResponse
	13,  // 115: luceneserver.LuceneServer.liveSettingsV2:output_type -> luceneserver.LiveSettingsV2Response
	16,  // 116: luceneserver.LuceneServer.registerFields:output_type -> luceneserver.FieldDefResponse
	16,  // 117: luceneserver.LuceneServer.updateFields:output_type -> luceneserver.FieldDefResponse
	18,  // 118: luceneserver.LuceneServer.settings:output_type -> luceneserver.SettingsResponse
	20,  // 119: luceneserver.LuceneServer.settingsV2:output_type -> luceneserver.SettingsV2Response
	22,  // 120: luceneserver.LuceneServer.startIndex:output_type -> luceneserver.StartIndexResponse
	38,  // 121: luceneserver.LuceneServer.stopIndex:output_type -> luceneserver.DummyResponse
	25,  // 122: luceneserver.LuceneServer.addDocuments:output_type -> luceneserver.AddDocumentResponse
	27,  // 123: luceneserver.LuceneServer.refresh:output_type -> luceneserver.RefreshResponse
	29,  // 124: luceneserver.LuceneServer.commit:output_type -> luceneserver.CommitResponse
	31,  // 125: luceneserver.LuceneServer.stats:output_type -> luceneserver.StatsResponse
	110, // 126: luceneserver.LuceneServer.search:output_type -> luceneserver.SearchResponse
	111, // 127: luceneserver.LuceneServer.searchV2:output_type -> google.protobuf.Any
	25,  // 128: luceneserver.LuceneServer.delete:output_type -> luceneserver.AddDocumentResponse
	25,  // 129: luceneserver.LuceneServer.deleteByQuery:output_type -> luceneserver.AddDocumentResponse
	35,  // 130: luceneserver.LuceneServer.deleteAll:output_type -> luceneserver.DeleteAllDocumentsResponse
	37,  // 131: luceneserver.LuceneServer.deleteIndex:output_type -> luceneserver.DeleteIndexResponse
	112, // 132: luceneserver.LuceneServer.buildSuggest:output_type -> luceneserver.BuildSuggestResponse
	113, // 133: luceneserver.LuceneServer.suggestLookup:output_type -> luceneserver.SuggestLookupResponse
	112, // 134: luceneserver.LuceneServer.updateSuggest:output_type -> luceneserver.BuildSuggestResponse
	41,  // 135: luceneserver.LuceneServer.createSnapshot:output_type -> luceneserver.CreateSnapshotResponse
	44,  // 136: luceneserver.LuceneServer.releaseSnapshot:output_type -> luceneserver.ReleaseSnapshotResponse
	46,  // 137: luceneserver.LuceneServer.getAllSnapshotIndexGen:output_type -> luceneserver.GetAllSnapshotGenResponse
	48,  // 138: luceneserver.LuceneServer.backupIndex:output_type -> luceneserver.BackupIndexResponse
	52,  // 139: luceneserver.LuceneServer.deleteIndexBackup:output_type -> luceneserver.DeleteIndexBackupResponse
	50,  // 140: luceneserver.LuceneServer.backupWarmingQueries:output_type -> luceneserver.BackupWarmingQueriesResponse
	58,  // 141: luceneserver.LuceneServer.state:output_type -> luceneserver.StateResponse
	70,  // 142: luceneserver.LuceneServer.status:output_type -> luceneserver.HealthCheckResponse
	70,  // 143: luceneserver.LuceneServer.ready:output_type -> luceneserver.HealthCheckResponse
	114, // 144: luceneserver.LuceneServer.metrics:output_type -> google.api.HttpBody
	54,  // 145: luceneserver.LuceneServer.indices:output_type -> luceneserver.IndicesResponse
	81,  // 146: luceneserver.LuceneServer.forceMerge:output_type -> luceneserver.ForceMergeResponse
	83,  // 147: luceneserver.LuceneServer.forceMergeDeletes:output_type -> luceneserver.ForceMergeDeletesResponse
	90,  // 148: luceneserver.LuceneServer.custom:output_type -> luceneserver.CustomResponse
	60,  // 149: luceneserver.ReplicationServer.addReplicas:output_type -> luceneserver.AddReplicaResponse
	61,  // 150: luceneserver.ReplicationServer.recvCopyState:output_type -> luceneserver.CopyState
	72,  // 151: luceneserver.ReplicationServer.sendRawFile:output_type -> luceneserver.TransferStatus
	68,  // 152: luceneserver.ReplicationServer.recvRawFile:output_type -> luceneserver.RawFileChunk
	68,  // 153: luceneserver.ReplicationServer.recvRawFileV2:output_type -> luceneserver.RawFileChunk
	72,  // 154: luceneserver.ReplicationServer.copyFiles:output_type -> luceneserver.TransferStatus
	72,  // 155: luceneserver.ReplicationServer.newNRTPoint:output_type -> luceneserver.TransferStatus
	75,  // 156: luceneserver.ReplicationServer.writeNRTPoint:output_type -> luceneserver.SearcherVersion
	75,  // 157: luceneserver.ReplicationServer.getCurrentSearcherVersion:output_type -> luceneserver.SearcherVersion
	77,  // 158: luceneserver.ReplicationServer.getConnectedNodes:output_type -> luceneserver.GetNodesResponse
...
type LuceneServerClient interface {
	...
	// Search V2
	SearchV2(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*any.Any, error)
	// Delete documents
...
func (c *luceneServerClient) SearchV2(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*any.Any, error) {
	out := new(any.Any)
...
type LuceneServerServer interface {
	...
	// Search V2
	SearchV2(context.Context, *SearchRequest) (*any.Any, error)
	// Delete documents
...
func (*UnimplementedLuceneServerServer) SearchV2(context.Context, *SearchRequest) (*any.Any, error) {
