...
var file_yelp_nrtsearch_luceneserver_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x52, 0x09, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x22, 0xa5,
	0x09, 0x0a, 0x11, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x4c, 0x69, 0x76, 0x65, 0x53, 0x65, 0x74, 0x74,
	...
	0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x22, 0xee, 0x02, 0x0a, 0x0e, 0x49, 0x6e, 0x64, 0x65, 0x78,
	...
	0x12, 0x0b, 0x0a, 0x07, 0x4f, 0x6e, 0x67, 0x6f, 0x69, 0x6e, 0x67, 0x10, 0x03, 0x32, 0xaf, 0x1e,
	...
	0x2a, 0x12, 0x6f, 0x0a, 0x0b, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x65,
	0x12, 0x20, 0x2e, 0x6c, 0x75, 0x63, 0x65, 0x6e, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e,
	0x47, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x21, 0x2e, 0x6c, 0x75, 0x63, 0x65, 0x6e, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x2e, 0x47, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x1b, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x15, 0x22, 0x10, 0x2f,
	0x76, 0x31, 0x2f, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x3a,
...
var file_yelp_nrtsearch_luceneserver_proto_depIdxs = []int32{
	...
	87,  // 65: luceneserver.IndexStateInfo.settings:type_name -> luceneserver.IndexSettings
	88,  // 66: luceneserver.IndexStateInfo.liveSettings:type_name -> luceneserver.IndexLiveSettings
	96,  // 67: luceneserver.IndexStateInfo.fields:type_name -> luceneserver.IndexStateInfo.FieldsEntry
	97,  // 68: luceneserver.GlobalStateInfo.indices:type_name -> luceneserver.GlobalStateInfo.IndicesEntry
	98,  // 69: luceneserver.CustomRequest.params:type_name -> luceneserver.CustomRequest.ParamsEntry
	99,  // 70: luceneserver.CustomResponse.response:type_name -> luceneserver.CustomResponse.ResponseEntry
	28,  // 71: luceneserver.AddDocumentRequest.MultiValuedField.faceHierarchyPaths:type_name -> luceneserver.FacetHierarchyPath
	94,  // 72: luceneserver.AddDocumentRequest.FieldsEntry.value:type_name -> luceneserver.AddDocumentRequest.MultiValuedField
	16,  // 73: luceneserver.IndexStateInfo.FieldsEntry.value:type_name -> luceneserver.Field
	90,  // 74: luceneserver.GlobalStateInfo.IndicesEntry.value:type_name -> luceneserver.IndexGlobalState
	10,  // 75: luceneserver.LuceneServer.createIndex:input_type -> luceneserver.CreateIndexRequest
	12,  // 76: luceneserver.LuceneServer.liveSettings:input_type -> luceneserver.LiveSettingsRequest
	14,  // 77: luceneserver.LuceneServer.liveSettingsV2:input_type -> luceneserver.LiveSettingsV2Request
	18,  // 78: luceneserver.LuceneServer.registerFields:input_type -> luceneserver.FieldDefRequest
	18,  // 79: luceneserver.LuceneServer.updateFields:input_type -> luceneserver.FieldDefRequest
	20,  // 80: luceneserver.LuceneServer.settings:input_type -> luceneserver.SettingsRequest
	22,  // 81: luceneserver.LuceneServer.settingsV2:input_type -> luceneserver.SettingsV2Request
	24,  // 82: luceneserver.LuceneServer.startIndex:input_type -> luceneserver.StartIndexRequest
	25,  // 83: luceneserver.LuceneServer.startIndexV2:input_type -> luceneserver.StartIndexV2Request
	43,  // 84: luceneserver.LuceneServer.stopIndex:input_type -> luceneserver.StopIndexRequest
	44,  // 85: luceneserver.LuceneServer.reloadState:input_type -> luceneserver.ReloadStateRequest
	27,  // 86: luceneserver.LuceneServer.addDocuments:input_type -> luceneserver.AddDocumentRequest
	30,  // 87: luceneserver.LuceneServer.refresh:input_type -> luceneserver.RefreshRequest
	32,  // 88: luceneserver.LuceneServer.commit:input_type -> luceneserver.CommitRequest
	34,  // 89: luceneserver.LuceneServer.stats:input_type -> luceneserver.StatsRequest
	110, // 90: luceneserver.LuceneServer.search:input_type -> luceneserver.SearchRequest
	110, // 91: luceneserver.LuceneServer.searchV2:input_type -> luceneserver.SearchRequest
	27,  // 92: luceneserver.LuceneServer.delete:input_type -> luceneserver.AddDocumentRequest
	82,  // 93: luceneserver.LuceneServer.deleteByQuery:input_type -> luceneserver.DeleteByQueryRequest
	38,  // 94: luceneserver.LuceneServer.deleteAll:input_type -> luceneserver.DeleteAllDocumentsRequest
	40,  // 95: luceneserver.LuceneServer.deleteIndex:input_type -> luceneserver.DeleteIndexRequest
	46,  // 96: luceneserver.LuceneServer.createSnapshot:input_type -> luceneserver.CreateSnapshotRequest
	49,  // 97: luceneserver.LuceneServer.releaseSnapshot:input_type -> luceneserver.ReleaseSnapshotRequest
	51,  // 98: luceneserver.LuceneServer.getAllSnapshotIndexGen:input_type -> luceneserver.GetAllSnapshotGenRequest
	53,  // 99: luceneserver.LuceneServer.backupWarmingQueries:input_type -> luceneserver.BackupWarmingQueriesRequest
	59,  // 100: luceneserver.LuceneServer.globalState:input_type -> luceneserver.GlobalStateRequest
	61,  // 101: luceneserver.LuceneServer.state:input_type -> luceneserver.StateRequest
	...
	111, // 104: luceneserver.LuceneServer.metrics:input_type -> google.protobuf.Empty
	...
	63,  // 109: luceneserver.ReplicationServer.addReplicas:input_type -> luceneserver.AddReplicaRequest
	69,  // 110: luceneserver.ReplicationServer.recvCopyState:input_type -> luceneserver.CopyStateRequest
	...
	68,  // 114: luceneserver.ReplicationServer.copyFiles:input_type -> luceneserver.CopyFiles
	...
	11,  // 119: luceneserver.LuceneServer.createIndex:output_type -> luceneserver.CreateIndexResponse
	13,  // 120: luceneserver.LuceneServer.liveSettings:output_type -> luceneserver.LiveSettingsResponse
	15,  // 121: luceneserver.LuceneServer.liveSettingsV2:output_type -> luceneserver.LiveSettingsV2Response
	19,  // 122: luceneserver.LuceneServer.registerFields:output_type -> luceneserver.FieldDefResponse
	19,  // 123: luceneserver.LuceneServer.updateFields:output_type -> luceneserver.FieldDefResponse
	21,  // 124: luceneserver.LuceneServer.settings:output_type -> luceneserver.SettingsResponse
	23,  // 125: luceneserver.LuceneServer.settingsV2:output_type -> luceneserver.SettingsV2Response
	26,  // 126: luceneserver.LuceneServer.startIndex:output_type -> luceneserver.StartIndexResponse
	26,  // 127: luceneserver.LuceneServer.startIndexV2:output_type -> luceneserver.StartIndexResponse
	42,  // 128: luceneserver.LuceneServer.stopIndex:output_type -> luceneserver.DummyResponse
	45,  // 129: luceneserver.LuceneServer.reloadState:output_type -> luceneserver.ReloadStateResponse
	29,  // 130: luceneserver.LuceneServer.addDocuments:output_type -> luceneserver.AddDocumentResponse
	31,  // 131: luceneserver.LuceneServer.refresh:output_type -> luceneserver.RefreshResponse
	33,  // 132: luceneserver.LuceneServer.commit:output_type -> luceneserver.CommitResponse
	35,  // 133: luceneserver.LuceneServer.stats:output_type -> luceneserver.StatsResponse
	112, // 134: luceneserver.LuceneServer.search:output_type -> luceneserver.SearchResponse
	113, // 135: luceneserver.LuceneServer.searchV2:output_type -> google.protobuf.Any
	29,  // 136: luceneserver.LuceneServer.delete:output_type -> luceneserver.AddDocumentResponse
	29,  // 137: luceneserver.LuceneServer.deleteByQuery:output_type -> luceneserver.AddDocumentResponse
	39,  // 138: luceneserver.LuceneServer.deleteAll:output_type -> luceneserver.DeleteAllDocumentsResponse
	41,  // 139: luceneserver.LuceneServer.deleteIndex:output_type -> luceneserver.DeleteIndexResponse
	47,  // 140: luceneserver.LuceneServer.createSnapshot:output_type -> luceneserver.CreateSnapshotResponse
	50,  // 141: luceneserver.LuceneServer.releaseSnapshot:output_type -> luceneserver.ReleaseSnapshotResponse
	52,  // 142: luceneserver.LuceneServer.getAllSnapshotIndexGen:output_type -> luceneserver.GetAllSnapshotGenResponse
	54,  // 143: luceneserver.LuceneServer.backupWarmingQueries:output_type -> luceneserver.BackupWarmingQueriesResponse
	60,  // 144: luceneserver.LuceneServer.globalState:output_type -> luceneserver.GlobalStateResponse
	62,  // 145: luceneserver.LuceneServer.state:output_type -> luceneserver.StateResponse
	73,  // 146: luceneserver.LuceneServer.status:output_type -> luceneserver.HealthCheckResponse
	73,  // 147: luceneserver.LuceneServer.ready:output_type -> luceneserver.HealthCheckResponse
	114, // 148: luceneserver.LuceneServer.metrics:output_type -> google.api.HttpBody
	56,  // 149: luceneserver.LuceneServer.indices:output_type -> luceneserver.IndicesResponse
	84,  // 150: luceneserver.LuceneServer.forceMerge:output_type -> luceneserver.ForceMergeResponse
	86,  // 151: luceneserver.LuceneServer.forceMergeDeletes:output_type -> luceneserver.ForceMergeDeletesResponse
	93,  // 152: luceneserver.LuceneServer.custom:output_type -> luceneserver.CustomResponse
	64,  // 153: luceneserver.ReplicationServer.addReplicas:output_type -> luceneserver.AddReplicaResponse
	65,  // 154: luceneserver.ReplicationServer.recvCopyState:output_type -> luceneserver.CopyState
	75,  // 155: luceneserver.ReplicationServer.sendRawFile:output_type -> luceneserver.TransferStatus
	71,  // 156: luceneserver.ReplicationServer.recvRawFile:output_type -> luceneserver.RawFileChunk
	71,  // 157: luceneserver.ReplicationServer.recvRawFileV2:output_type -> luceneserver.RawFileChunk
	75,  // 158: luceneserver.ReplicationServer.copyFiles:output_type -> luceneserver.TransferStatus
	75,  // 159: luceneserver.ReplicationServer.newNRTPoint:output_type -> luceneserver.TransferStatus
	78,  // 160: luceneserver.ReplicationServer.writeNRTPoint:output_type -> luceneserver.SearcherVersion
	78,  // 161: luceneserver.ReplicationServer.getCurrentSearcherVersion:output_type -> luceneserver.SearcherVersion
	80,  // 162: luceneserver.ReplicationServer.getConnectedNodes:output_type -> luceneserver.GetNodesResponse
