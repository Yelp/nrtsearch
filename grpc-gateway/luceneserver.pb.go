...
var file_yelp_nrtsearch_luceneserver_proto_rawDesc = []byte{
	...
	0x01, 0x2a, 0xa2, 0x01, 0x0a, 0x09, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x03, 0x5f, 0x49, 0x44, 0x10, 0x0c, 0x2a, 0x64, 0x0a, 0x0c, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x4f,
	...
	0x02, 0x12, 0x0b, 0x0a, 0x07, 0x4f, 0x6e, 0x67, 0x6f, 0x69, 0x6e, 0x67, 0x10, 0x03, 0x32, 0xb4,
	0x18, 0x0a, 0x0c, 0x4c, 0x75, 0x63, 0x65, 0x6e, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12,
	...
	0x65, 0x78, 0x3a, 0x01, 0x2a, 0x12, 0x6f, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x1a,
	0x2e, 0x6c, 0x75, 0x63, 0x65, 0x6e, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x53, 0x74,
	...
	0x76, 0x31, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x50, 0x0a, 0x07, 0x6d, 0x65, 0x74,
	...
	0x67, 0x65, 0x3a, 0x01, 0x2a, 0x32, 0xd1, 0x05, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x3b, 0x0a, 0x1e, 0x63, 0x6f, 0x6d,
...
var file_yelp_nrtsearch_luceneserver_proto_depIdxs = []int32{
	...
	89, // 11: luceneserver.SettingsRequest.indexSort:type_name -> luceneserver.SortFields
	...
	85, // 14: luceneserver.AddDocumentRequest.fields:type_name -> luceneserver.AddDocumentRequest.FieldsEntry
	...
	80, // 36: luceneserver.GetNodesResponse.nodes:type_name -> luceneserver.NodeInfo
	90, // 37: luceneserver.DeleteByQueryRequest.query:type_name -> luceneserver.Query
	...
	84, // 40: luceneserver.AddDocumentRequest.FieldsEntry.value:type_name -> luceneserver.AddDocumentRequest.MultiValuedField
	...
	91, // 52: luceneserver.LuceneServer.search:input_type -> luceneserver.SearchRequest
	18, // 53: luceneserver.LuceneServer.delete:input_type -> luceneserver.AddDocumentRequest
	81, // 54: luceneserver.LuceneServer.deleteByQuery:input_type -> luceneserver.DeleteByQueryRequest
	...
	92, // 66: luceneserver.LuceneServer.metrics:input_type -> google.protobuf.Empty
	56, // 67: luceneserver.LuceneServer.indices:input_type -> luceneserver.IndicesRequest
	82, // 68: luceneserver.LuceneServer.forceMerge:input_type -> luceneserver.ForceMergeRequest
	62, // 69: luceneserver.ReplicationServer.addReplicas:input_type -> luceneserver.AddReplicaRequest
	68, // 70: luceneserver.ReplicationServer.recvCopyState:input_type -> luceneserver.CopyStateRequest
	71, // 71: luceneserver.ReplicationServer.sendRawFile:input_type -> luceneserver.RawFileChunk
	70, // 72: luceneserver.ReplicationServer.recvRawFile:input_type -> luceneserver.FileInfo
	67, // 73: luceneserver.ReplicationServer.copyFiles:input_type -> luceneserver.CopyFiles
	75, // 74: luceneserver.ReplicationServer.newNRTPoint:input_type -> luceneserver.NewNRTPoint
	76, // 75: luceneserver.ReplicationServer.writeNRTPoint:input_type -> luceneserver.IndexName
	76, // 76: luceneserver.ReplicationServer.getCurrentSearcherVersion:input_type -> luceneserver.IndexName
	78, // 77: luceneserver.ReplicationServer.getConnectedNodes:input_type -> luceneserver.GetNodesRequest
	8,  // 78: luceneserver.LuceneServer.createIndex:output_type -> luceneserver.CreateIndexResponse
	10, // 79: luceneserver.LuceneServer.liveSettings:output_type -> luceneserver.LiveSettingsResponse
	13, // 80: luceneserver.LuceneServer.registerFields:output_type -> luceneserver.FieldDefResponse
	13, // 81: luceneserver.LuceneServer.updateFields:output_type -> luceneserver.FieldDefResponse
	15, // 82: luceneserver.LuceneServer.settings:output_type -> luceneserver.SettingsResponse
	17, // 83: luceneserver.LuceneServer.startIndex:output_type -> luceneserver.StartIndexResponse
	33, // 84: luceneserver.LuceneServer.stopIndex:output_type -> luceneserver.DummyResponse
	20, // 85: luceneserver.LuceneServer.addDocuments:output_type -> luceneserver.AddDocumentResponse
	22, // 86: luceneserver.LuceneServer.refresh:output_type -> luceneserver.RefreshResponse
	24, // 87: luceneserver.LuceneServer.commit:output_type -> luceneserver.CommitResponse
	26, // 88: luceneserver.LuceneServer.stats:output_type -> luceneserver.StatsResponse
	93, // 89: luceneserver.LuceneServer.search:output_type -> luceneserver.SearchResponse
	20, // 90: luceneserver.LuceneServer.delete:output_type -> luceneserver.AddDocumentResponse
	20, // 91: luceneserver.LuceneServer.deleteByQuery:output_type -> luceneserver.AddDocumentResponse
	30, // 92: luceneserver.LuceneServer.deleteAll:output_type -> luceneserver.DeleteAllDocumentsResponse
	32, // 93: luceneserver.LuceneServer.deleteIndex:output_type -> luceneserver.DeleteIndexResponse
	36, // 94: luceneserver.LuceneServer.buildSuggest:output_type -> luceneserver.BuildSuggestResponse
	38, // 95: luceneserver.LuceneServer.suggestLookup:output_type -> luceneserver.SuggestLookupResponse
	36, // 96: luceneserver.LuceneServer.updateSuggest:output_type -> luceneserver.BuildSuggestResponse
	48, // 97: luceneserver.LuceneServer.createSnapshot:output_type -> luceneserver.CreateSnapshotResponse
	51, // 98: luceneserver.LuceneServer.releaseSnapshot:output_type -> luceneserver.ReleaseSnapshotResponse
	53, // 99: luceneserver.LuceneServer.getAllSnapshotIndexGen:output_type -> luceneserver.GetAllSnapshotGenResponse
	55, // 100: luceneserver.LuceneServer.backupIndex:output_type -> luceneserver.BackupIndexResponse
	61, // 101: luceneserver.LuceneServer.state:output_type -> luceneserver.StateResponse
	73, // 102: luceneserver.LuceneServer.status:output_type -> luceneserver.HealthCheckResponse
	94, // 103: luceneserver.LuceneServer.metrics:output_type -> google.api.HttpBody
	57, // 104: luceneserver.LuceneServer.indices:output_type -> luceneserver.IndicesResponse
	83, // 105: luceneserver.LuceneServer.forceMerge:output_type -> luceneserver.ForceMergeResponse
	63, // 106: luceneserver.ReplicationServer.addReplicas:output_type -> luceneserver.AddReplicaResponse
	64, // 107: luceneserver.ReplicationServer.recvCopyState:output_type -> luceneserver.CopyState
	74, // 108: luceneserver.ReplicationServer.sendRawFile:output_type -> luceneserver.TransferStatus
	71, // 109: luceneserver.ReplicationServer.recvRawFile:output_type -> luceneserver.RawFileChunk
	74, // 110: luceneserver.ReplicationServer.copyFiles:output_type -> luceneserver.TransferStatus
	74, // 111: luceneserver.ReplicationServer.newNRTPoint:output_type -> luceneserver.TransferStatus
	77, // 112: luceneserver.ReplicationServer.writeNRTPoint:output_type -> luceneserver.SearcherVersion
	77, // 113: luceneserver.ReplicationServer.getCurrentSearcherVersion:output_type -> luceneserver.SearcherVersion
	79, // 114: luceneserver.ReplicationServer.getConnectedNodes:output_type -> luceneserver.GetNodesResponse
