...
.. code-block:: protobuf
  ...
  message Highlight {
    ...
    message Settings {
        ...
        // Optional limit to the number of phrases or terms to be highlighted in each fragment.
        // Ordered by boost, then position. If omitted, all matches will be highlighted;
        // Any non-positive number will be ignored.
        google.protobuf.UInt32Value max_number_of_highlighted_phrase_per_fragment = 18;
    }
