...
import yelp.platypus.server.grpc.BuildSuggestRequest;
import yelp.platypus.server.grpc.BuildSuggestResponse;
import yelp.platypus.server.grpc.FuzzySuggester;
import yelp.platypus.server.grpc.OneHighlight;
import yelp.platypus.server.grpc.SearchRequest;
import yelp.platypus.server.grpc.SuggestLookupHighlight;
import yelp.platypus.server.grpc.SuggestNonLocalSource;
...
public class BuildSuggestHandler implements Handler<BuildSuggestRequest, BuildSuggestResponse> {
    ...
    private Lookup getSuggester(IndexState indexState, BuildSuggestRequest buildSuggestRequest) throws IOException {
        ...
        if (buildSuggestRequest.hasFuzzySuggester()) {
            ...
            int options = 0;
            yelp.platypus.server.grpc.AnalyzingSuggester
                analyzingSuggester = buildSuggestRequest.getAnalyzingSuggester();
