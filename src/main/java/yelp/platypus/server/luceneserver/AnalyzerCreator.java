...
import yelp.platypus.server.grpc.ConditionalTokenFilter;
...
public class AnalyzerCreator {
    ...
    static Analyzer getAnalyzer(yelp.platypus.server.grpc.Analyzer analyzer) {
     ...
     */
    private static Analyzer getCustomAnalyzer(yelp.platypus.server.grpc.CustomAnalyzer analyzer) {
    ...
    static boolean isAnalyzerDefined(yelp.platypus.server.grpc.Analyzer analyzer) {
