...
/** Factory class that handles registration and creation of {@link FetchTasks.FetchTask}s. */
public class FetchTaskCreator {
   ...
   * {@link com.yelp.nrtsearch.server.grpc.SearchRequest}.
   *
   * @param grpcFetchTask task definition message
   * @return {@link FetchTasks.FetchTask} instance
   */
