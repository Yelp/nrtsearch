...
/**
 * Helper class for creating instances of {@link CustomCollectorManager} from the grpc {@link
 * Collector} messages.
 */
public class CollectorCreator {
  ...
  /**
   * Create {@link CustomCollectorManager} for the given {@link Collector} definition message.
   *
   ...
   */
  public static CustomCollectorManager<
          ? extends org.apache.lucene.search.Collector, ? extends CollectorResult>
      createCollectorManager(SearchContext context, String name, Collector collector) {
    switch (collector.getCollectorsCase()) {
      case MAX:
        return new MaxValueCollectorManager(context, name, collector.getMax());
      default:
