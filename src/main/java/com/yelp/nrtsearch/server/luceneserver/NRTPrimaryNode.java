...
public class NRTPrimaryNode extends PrimaryNode {
    ...
    public static class ReplicaDetails {
        ...
        ReplicaDetails(int replicaId, ReplicationServerClient replicationServerClient) {
            ...
            this.inetSocketAddress = new InetSocketAddress(replicationServerClient.getHost(), replicationServerClient.getPort());
        }
        ...
        * */
        ...
        public boolean equals(Object o) {
            ...
            return replicaId == that.replicaId &&
                    Objects.equals(inetSocketAddress, that.inetSocketAddress);
        }
        ...
        @Override
        public int hashCode() {
            return Objects.hash(replicaId, inetSocketAddress);
        }
    }
...
//                    }
    ...
    public void close() throws IOException {
        ...
        while (it.hasNext()) {
            ...
            logger.info(String.format("CLOSE NRT PRIMARY, closing replica channel host:%s, port:%s", replicationServerClient.getHost(), replicationServerClient.getPort()));
