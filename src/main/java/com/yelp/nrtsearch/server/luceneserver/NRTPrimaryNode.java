...
public class NRTPrimaryNode extends PrimaryNode {
    ...
    public NRTPrimaryNode(String indexName, HostPort hostPort, IndexWriter writer, int id, long primaryGen, long forcePrimaryVersion,
    ...
    public static class ReplicaDetails {
        ...
        ReplicaDetails(int replicaId, ReplicationServerClient replicationServerClient) {
            ...
            this.hostPort = new HostPort(replicationServerClient.getHost(), replicationServerClient.getPort());
        }
    ...
    protected void preCopyMergedSegmentFiles(SegmentCommitInfo info, Map<String, FileMetaData> files) throws IOException {
        ...
        logger.info("top: warm merge " + info + " to " + replicasInfos.size() + " replicas; localAddress=" + hostPort + ": files=" + files.keySet());
        message("top: warm merge " + info + " to " + replicasInfos.size() + " replicas; localAddress=" + hostPort + ": files=" + files.keySet());
