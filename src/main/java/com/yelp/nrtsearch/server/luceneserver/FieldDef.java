...
public class FieldDef implements Closeable {
  ...
  /**
   * {@link FieldType} minus doc values, used during indexing because we separately add the doc
   * values field and then the "normal" field.
   */
  ...
  public FieldDef(String name, DoubleValuesSource valueSource) {
    this(
        name,
        null,
        FieldDef.FieldValueType.VIRTUAL,
        null,
        null,
        null,
        true,
