...
public class QueryUtils {
  private static final int DEFAULT_MAX_EDITS_LOW = 3; // default low value for auto fuzziness
  private static final int DEFAULT_MAX_EDITS_HIGH = 6; // default high value for auto fuzziness
  ...
  public static int computeMaxEditsFromTermLength(
    ...
    if (low == 0 && high == 0) {
      low = DEFAULT_MAX_EDITS_LOW;
      high = DEFAULT_MAX_EDITS_HIGH;
    }
    if (low < 0) {
