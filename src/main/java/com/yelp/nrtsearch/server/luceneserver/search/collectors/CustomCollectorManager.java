...
/**
 * Extension of lucene {@link CollectorManager} interface. Allows us to add any method that might be
 * useful.
 *
 * @param <C> collector type
 * @param <T> parallel collection reduction type
 */
public interface CustomCollectorManager<C extends Collector, T> extends CollectorManager<C, T> {
