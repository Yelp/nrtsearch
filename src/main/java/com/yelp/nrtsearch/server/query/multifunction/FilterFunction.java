 ...
 * com.yelp.nrtsearch.server.query.multifunction.MultiFunctionScoreQuery}. Can optionally have a
 * filter {@link Query} to apply this function only to those matching docs. Functions may also
 * specify a weight to scale the result.
 */
