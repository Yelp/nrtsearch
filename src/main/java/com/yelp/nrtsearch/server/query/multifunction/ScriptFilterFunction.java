...
/**
 * Filter function implementation that produces document values with a provided {@link ScoreScript}
 * definition.
 */
public class ScriptFilterFunction extends FilterFunction {
  ...
  public final class ScriptLeafFunction implements LeafFunction {
    ...
    private final QueryUtils.SettableDoubleValues innerScoreValues =
        new QueryUtils.SettableDoubleValues();
