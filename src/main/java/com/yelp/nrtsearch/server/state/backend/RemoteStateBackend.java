...
public class RemoteStateBackend implements StateBackend {
  ...
  public RemoteStateBackend(GlobalState globalState) {
    ...
    this.localFilePath = globalState.getStateDir().resolve(StateUtils.GLOBAL_STATE_FOLDER);
  ...
  public GlobalStateInfo loadOrCreateGlobalState() throws IOException {
    ...
    if (!exists) {
      ...
      StateUtils.writeToFile(stateBytes, localFilePath, StateUtils.GLOBAL_STATE_FILE);
  ...
  public IndexStateInfo loadIndexState(String indexIdentifier) throws IOException {
    ...
    if (!exists) {
      ...
      StateUtils.writeToFile(stateBytes, localIndexStateDirPath, StateUtils.INDEX_STATE_FILE);
  ...
  public void commitIndexState(String indexIdentifier, IndexStateInfo indexStateInfo)
    ...
    StateUtils.writeToFile(stateBytes, indexStatePath, StateUtils.INDEX_STATE_FILE);
