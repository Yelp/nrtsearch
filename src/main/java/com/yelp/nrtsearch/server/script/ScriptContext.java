 ...
 * required that they be used by the {@link ScriptEngine}. For example, the {@link JsScriptEngine}
 * compiles to a Factory that produces a {@link org.apache.lucene.search.DoubleValuesSource}
 * directly. This stateful factory Class will not conform with the stateful factory contract.
 * Instead, the abstract {@link ScoreScript.SegmentFactory} is provided as a {@link
