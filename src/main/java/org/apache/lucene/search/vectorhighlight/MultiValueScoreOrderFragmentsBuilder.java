...
public class MultiValueScoreOrderFragmentsBuilder extends MultiValueSimpleFragmentsBuilder {

  /** a constructor. */
  public MultiValueScoreOrderFragmentsBuilder() {
    super();
  }
   ...
   */
  public MultiValueScoreOrderFragmentsBuilder(String[] preTags, String[] postTags) {
    super(preTags, postTags);
  }

  public MultiValueScoreOrderFragmentsBuilder(BoundaryScanner bs) {
    super(bs);
  }
  ...
  /** Comparator for {@link WeightedFragInfo} by boost, breaking ties by offset. */
