 ...
 */
public class MyTopScoreDocCollectorManager
    implements CollectorManager<MyTopScoreDocCollector, TopDocs> {
   ...
   * @deprecated Use {@link #MyTopScoreDocCollectorManager(int, ScoreDoc, int)}, the
   *     supportsConcurrency parameter is now a no-op.
   */
  @Deprecated
  public MyTopScoreDocCollectorManager(
   ...
   *     count accurate, but this will also make query processing slower.
   */
  public MyTopScoreDocCollectorManager(int numHits, ScoreDoc after, int totalHitsThreshold) {
   ...
   *     count accurate, but this will also make query processing slower.
   */
  public MyTopScoreDocCollectorManager(int numHits, int totalHitsThreshold) {
    this(numHits, null, totalHitsThreshold, true);
  }

  @Override
  public MyTopScoreDocCollector newCollector() {
    return new MyTopScoreDocCollector(numHits, after, totalHitsThreshold, minScoreAcc);
  }

  @Override
  public TopDocs reduce(Collection<MyTopScoreDocCollector> collectors) throws IOException {
