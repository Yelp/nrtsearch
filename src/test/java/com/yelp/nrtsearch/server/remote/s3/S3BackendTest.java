...
public class S3BackendTest {
  ...
  public void testDownloadIndexFiles_batched() throws IOException {
    ...
    S3Backend batchedBackend =
        new S3Backend(
            BUCKET_NAME,
            false,
            new S3Backend.S3BackendConfig(false, 0, 1, 2, 0, true),
  ...
  public void testS3BackendConfigDefaults() {
    S3Backend.S3BackendConfig config = new S3Backend.S3BackendConfig(false, 0, 1, 0, 0, true);
  ...
  public void testS3BackendConfigDownloadBatchSize() {
    S3Backend.S3BackendConfig config = new S3Backend.S3BackendConfig(false, 0, 1, 10, 0, true);
  ...
  public void testS3BackendConfigDownloadBatchSizeNegative() {
    try {
      new S3Backend.S3BackendConfig(false, 0, 1, -1, 0, true);
  ...
  public void testDownloadBatchSizeGetter() {
    try (S3Backend backend =
        new S3Backend(
            BUCKET_NAME,
            false,
            new S3Backend.S3BackendConfig(false, 0, 1, 5, 0, true),
            new S3Util.S3ClientBundle(mock(S3Client.class), null))) {
  ...
  public void testS3BackendConfigUploadBatchSize() {
    S3Backend.S3BackendConfig config = new S3Backend.S3BackendConfig(false, 0, 1, 0, 10, true);
  ...
  public void testS3BackendConfigUploadBatchSizeNegative() {
    try {
      new S3Backend.S3BackendConfig(false, 0, 1, 0, -1, true);
  ...
  public void testUploadBatchSizeGetter() {
    try (S3Backend backend =
        new S3Backend(
            BUCKET_NAME,
            false,
            new S3Backend.S3BackendConfig(false, 0, 1, 0, 7, true),
            new S3Util.S3ClientBundle(mock(S3Client.class), null))) {
