...
import static com.yelp.nrtsearch.server.analysis.AnalyzerCreator.getStandardAnalyzer;
...
public class AnalyzerCreatorTest {
  ...
  public void testInvalidTokenFilterConstructor() {
    ...
    try {
      ...
      assertEquals(
          "Factory com.yelp.nrtsearch.server.analysis.AnalyzerCreatorTest$MyBadTokenFilter "
  ...
  public void testInvalidCharFilterConstructor() {
    ...
    try {
      ...
      assertEquals(
          "Factory com.yelp.nrtsearch.server.analysis.AnalyzerCreatorTest$MyBadCharFilter "
              + "cannot be instantiated. This is likely due to missing Map<String,String> constructor.",
          e.getMessage());
    }
  }
