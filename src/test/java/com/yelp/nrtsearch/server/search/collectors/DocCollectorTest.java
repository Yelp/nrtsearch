...
import com.yelp.nrtsearch.server.search.SearchStatsWrapper;
import com.yelp.nrtsearch.server.search.TerminateAfterWrapper;
...
public class DocCollectorTest {
  ...
  private static class TestDocCollector extends DocCollector {
    ...
    public TestDocCollector(SearchRequest request, IndexState indexState) {
      super(
          CollectorCreatorContext.fromRequest(request, indexState, null, Collections.emptyMap(), null),
