...
public class ZipUtilsTest {
  ...
  public void testUnzip() throws IOException {
    try (InputStream inputStream =
      ...
      List<String> actualExtractedFiles = ZipUtils.extractZip(inputStream, extractDirectory, true);
  ...
  public void testUnzipPlugin() throws IOException {
    try (InputStream inputStream =
      ...
      List<String> extractedFiles = ZipUtils.extractZip(inputStream, extractDirectory, false);
