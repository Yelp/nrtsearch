...
public class FileUtilsTest {
  ...
  public void testDeleteAllFilesInDir_notExist() throws IOException {
    FileUtils.deleteAllFilesInDir(folder.getRoot().toPath().resolve("notExist"));
  }

  @Test
  public void testDeleteAllFilesInDir_notDir() throws IOException {
    folder.newFile("file");
    FileUtils.deleteAllFilesInDir(folder.getRoot().toPath().resolve("file"));
  }
  ...
  public void testDeleteAllFilesInDir() throws IOException {
    ...
    FileUtils.deleteAllFilesInDir(folder.getRoot().toPath());
