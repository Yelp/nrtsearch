...
public class JsScriptEngineTest {
    ...
    public void testBindsIndexFields() throws Exception {
        ...
        SearchResponse searchResponse = doFunctionScoreQuery("long_field*3.0+double_field*5.0", Collections.emptyMap());
    ...
    public void testBindsAllScriptParamTypes() throws Exception {
        ...
        SearchResponse searchResponse = doFunctionScoreQuery("bool_p*2.0+int_p*3.0+long_p*5.0+float_p*7.0+double_p*11.0", params);
        assertEquals(2, searchResponse.getHitsCount());
    ...
    public void testBindsFieldsAndParams() throws Exception {
        ...
        SearchResponse searchResponse = doFunctionScoreQuery("param_1*long_field+param_2*float_field+param_3", params);
        assertEquals(2, searchResponse.getHitsCount());
    ...
    public void testBindsParamsFirst() throws Exception {
        ...
        SearchResponse searchResponse = doFunctionScoreQuery("param_1*long_field+count*double_field", params);
        assertEquals(2, searchResponse.getHitsCount());
    ...
    public void testExpressionsWithDifferentParams() throws Exception {
        ...
        VirtualField virtualField1 = VirtualField.newBuilder()
                .setName("expr_1")
        ...
        VirtualField virtualField2 = VirtualField.newBuilder()
                .setName("expr_2")
                .setScript(Script.newBuilder()
                        .setLang("js")
                        .setSource("param_3*long_field+param_2*count+param_1*float_field")
    ...
    private SearchResponse doFunctionScoreQuery(String scriptSource, Map<String, Script.ParamValue> params) {
