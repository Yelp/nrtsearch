...
public class FloatTermsCollectorManagerTest extends TermsCollectorManagerTestsBase {

  @ClassRule public static final GrpcCleanupRule grpcCleanup = new GrpcCleanupRule();

  protected FieldDefRequest getIndexDef(String name) throws IOException {
    return getFieldsFromResourceFile("/search/collection/terms_float.json");
  }
    ...
    return AddDocumentRequest.newBuilder()
        ...
        .putFields(
            ...
            AddDocumentRequest.MultiValuedField.newBuilder()
                .addValue(String.valueOf((id % 3) * 1.25f))
                .build())
        .putFields(
            "value_order",
            AddDocumentRequest.MultiValuedField.newBuilder()
        ...
        .putFields(
            "value_multi",
            AddDocumentRequest.MultiValuedField.newBuilder()
                .addValue(String.valueOf((id % 2) * 1.5f))
                .addValue(String.valueOf((id % 5) * 1.5f))
                .build())
        .putFields(
            "value_multi_order",
            AddDocumentRequest.MultiValuedField.newBuilder()
