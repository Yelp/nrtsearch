...
import yelp.platypus.server.grpc.Field;
import yelp.platypus.server.grpc.IntObject;
import yelp.platypus.server.grpc.NameAndParams;
...
public class AnalyzerCreatorTest {
    ...
    private static yelp.platypus.server.grpc.Analyzer getPredefinedAnalyzer(String name) {
        return yelp.platypus.server.grpc.Analyzer.newBuilder()
                .setPredefined(name)
                .build();
    }
    ...
    public void testCustomAnalyzerFactoryHtmlStripClassicFolding() throws IOException {
        yelp.platypus.server.grpc.Analyzer
            analyzerGrpc = yelp.platypus.server.grpc.Analyzer.newBuilder()
                .setCustom(yelp.platypus.server.grpc.CustomAnalyzer.newBuilder()
    ...
    public void testGetStandardAnalyzer() {
        assertSame(StandardAnalyzer.class, AnalyzerCreator.getStandardAnalyzer().getClass());
    }
    ...
    public void testHasAnalyzerNoField() {
        assertFalse(AnalyzerCreator.hasAnalyzer(null));
    }

    @Test
    public void testHasAnalyzerNoAnalyzer() {
        Field field = Field.newBuilder().build();
        assertFalse(AnalyzerCreator.hasAnalyzer(field));
    }
    ...
    public void testHasAnalyzerAnalyzerPresent() {
        ...
        assertTrue(AnalyzerCreator.hasAnalyzer(field));
    }
    ...
    private static yelp.platypus.server.grpc.Analyzer getPredefinedAnalyzer() {
        return yelp.platypus.server.grpc.Analyzer.newBuilder()
                .setPredefined("dummy")
                .build();
    }
    ...
    public void testIsAnalyzerDefinedNoAnalyzer() {
        assertFalse(AnalyzerCreator.isAnalyzerDefined(null));
    }

    @Test
    public void testIsAnalyzerDefinedAnalyzerPresentPredefinedAndCustomAbsent() {
        boolean analyzerDefined = AnalyzerCreator
            .isAnalyzerDefined(yelp.platypus.server.grpc.Analyzer.newBuilder()
                .build());
    ...
    public void testIsAnalyzerDefinedPredefinedPresentCustomAbsent() {
        boolean analyzerDefined = AnalyzerCreator.isAnalyzerDefined(getPredefinedAnalyzer());
    ...
    public void testIsAnalyzerDefinedCustomPresentPredefinedAbsent() {
        boolean analyzerDefined = AnalyzerCreator
            .isAnalyzerDefined(yelp.platypus.server.grpc.Analyzer.newBuilder()
                .setCustom(yelp.platypus.server.grpc.CustomAnalyzer.newBuilder().build())
                .build());
        assertTrue(analyzerDefined);
    }
