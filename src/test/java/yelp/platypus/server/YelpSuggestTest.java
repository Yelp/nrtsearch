...
import yelp.platypus.server.grpc.BuildSuggestRequest.Builder;
...
public class YelpSuggestTest extends TestIndexManager {
    ...
    private static yelp.platypus.server.grpc.BuildSuggestResponse buildSuggester(
        LuceneServerClient standaloneServerClient){
        Builder buildSuggestRequestBuilder = yelp.platypus.server.grpc.BuildSuggestRequest.newBuilder();
        ...
        buildSuggestRequestBuilder.setInfixSuggester(
            yelp.platypus.server.grpc.InfixSuggester.newBuilder().setAnalyzer("default").build());
        buildSuggestRequestBuilder.setNonLocalSource(
            yelp.platypus.server.grpc.SuggestNonLocalSource.newBuilder()
    ...
    public static void main(String[] args) throws Exception{
        ...
        // look up suggestions
        yelp.platypus.server.grpc.SuggestLookupRequest.Builder
            suggestLookupBuilder = yelp.platypus.server.grpc.SuggestLookupRequest.newBuilder();
        ...
        yelp.platypus.server.grpc.SuggestLookupResponse
            suggestResponse = standaloneServerClient.getBlockingStub().suggestLookup(suggestLookupBuilder.build());
        List<yelp.platypus.server.grpc.OneSuggestLookupResponse> suggestResponseResultsList = suggestResponse.getResultsList();
