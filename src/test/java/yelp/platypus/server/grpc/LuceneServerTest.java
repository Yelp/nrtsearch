...
import yelp.platypus.server.grpc.SearchResponse.Hit.CompositeFieldValue;
...
public class LuceneServerTest {
    ...
    public void testStats() throws IOException, InterruptedException {
        ...
        Assert.assertEquals(0, statsResponse.getCurrentSearcher().getNumDocs());
        ...
        assertEquals(0, statsResponse.getOrd());
        Assert.assertEquals(2, statsResponse.getCurrentSearcher().getNumDocs());
        assertEquals("started", statsResponse.getState());
    }
    ...
    public static void checkHits(SearchResponse.Hit hit) {
        ...
        Assert.assertEquals(expectedCount, fields.get("count").getFieldValueList().get(0).getIntValue());
        Assert.assertEquals(expectedLongField, fields.get("long_field").getFieldValueList().get(0).getLongValue());
        ...
        Assert.assertEquals(expectedDate, fields.get("date").getFieldValueList().get(0).getLongValue());
    }
