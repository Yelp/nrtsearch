...
import yelp.platypus.server.LuceneServerTestConfigurationFactory;
...
import static yelp.platypus.server.grpc.GrpcServer.rmDir;
...
public class SuggestTest {
    ...
    private void assertMultipleHighlightsOnIndexLoveLost(String text, String suggestName, long weight, String payload) {
        ...
        Assert.assertEquals("lo", suggestLookupHighLight.getOneHighlight(0).getText());
        Assert.assertEquals(true, suggestLookupHighLight.getOneHighlight(0).getIsHit());
        Assert.assertEquals("ve", suggestLookupHighLight.getOneHighlight(1).getText());
        Assert.assertEquals(false, suggestLookupHighLight.getOneHighlight(1).getIsHit());
        Assert.assertEquals(" ", suggestLookupHighLight.getOneHighlight(2).getText());
        Assert.assertEquals(false, suggestLookupHighLight.getOneHighlight(2).getIsHit());
        Assert.assertEquals("lo", suggestLookupHighLight.getOneHighlight(3).getText());
        Assert.assertEquals(true, suggestLookupHighLight.getOneHighlight(3).getIsHit());
        Assert.assertEquals("st", suggestLookupHighLight.getOneHighlight(4).getText());
        Assert.assertEquals(false, suggestLookupHighLight.getOneHighlight(4).getIsHit());
    ...
    private void assertOneHighlightOnIndexLoveLost(String text, String suggestName, long weight, String payload) {
        ...
        Assert.assertEquals("love ", suggestLookupHighLight.getOneHighlight(0).getText());
        Assert.assertEquals(false, suggestLookupHighLight.getOneHighlight(0).getIsHit());
        Assert.assertEquals("lost", suggestLookupHighLight.getOneHighlight(1).getText());
        Assert.assertEquals(true, suggestLookupHighLight.getOneHighlight(1).getIsHit());
        assertEquals(payload, results.get(0).getPayload());
    ...
    public void testInfixSuggesterWithContextsFromField() throws Exception {
        ...
        AddDocumentResponse addDocumentResponse = testAddDocs.addDocuments("addSuggestDocsWithContext.csv");
        BuildSuggestRequest.Builder buildSuggestRequestBuilder = BuildSuggestRequest.newBuilder();
        buildSuggestRequestBuilder.setSuggestName("suggest");
        buildSuggestRequestBuilder.setIndexName("test_index");
