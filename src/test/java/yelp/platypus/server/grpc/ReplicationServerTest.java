...
import yelp.platypus.server.utils.ArchiverImpl;
import yelp.platypus.server.utils.Tar;
import yelp.platypus.server.utils.TarImpl;
...
import static yelp.platypus.server.grpc.LuceneServerTest.RETRIEVED_VALUES;
import static yelp.platypus.server.grpc.LuceneServerTest.checkHits;
...
public class ReplicationServerTest {
    ...
    public void tearDown() throws IOException {
        ...
        GrpcServer.rmDir(Paths.get(luceneServerPrimary.getIndexDir()).getParent());
        GrpcServer.rmDir(Paths.get(luceneServerSecondary.getIndexDir()).getParent());
    }
    ...
    public void setUp() throws IOException {
        ...
        LuceneServerConfiguration
            luceneServerPrimaryConfiguration = LuceneServerTestConfigurationFactory.getConfig(Mode.PRIMARY);
